...
*/
    ...
    alias fz_bidi_direction = _Anonymous_2;
    ...
    enum FZ_BIDI_LTR = _Anonymous_2.FZ_BIDI_LTR;
    enum FZ_BIDI_RTL = _Anonymous_2.FZ_BIDI_RTL;
    enum FZ_BIDI_NEUTRAL = _Anonymous_2.FZ_BIDI_NEUTRAL;

    alias fz_bidi_flags = _Anonymous_3;
    ...
    enum FZ_BIDI_CLASSIFY_WHITE_SPACE = _Anonymous_3.FZ_BIDI_CLASSIFY_WHITE_SPACE;
    enum FZ_BIDI_REPLACE_TAB = _Anonymous_3.FZ_BIDI_REPLACE_TAB;
...
*/
    ...
    enum FZ_RI_PERCEPTUAL = _Anonymous_8.FZ_RI_PERCEPTUAL;
    enum FZ_RI_RELATIVE_COLORIMETRIC = _Anonymous_8.FZ_RI_RELATIVE_COLORIMETRIC;
    enum FZ_RI_SATURATION = _Anonymous_8.FZ_RI_SATURATION;
    enum FZ_RI_ABSOLUTE_COLORIMETRIC = _Anonymous_8.FZ_RI_ABSOLUTE_COLORIMETRIC;
...
*/
    ...
    enum FZ_MAX_COLORS = _Anonymous_9.FZ_MAX_COLORS;
    ...
    enum FZ_COLORSPACE_IS_DEVICE = _Anonymous_10.FZ_COLORSPACE_IS_DEVICE;
    enum FZ_COLORSPACE_IS_ICC = _Anonymous_10.FZ_COLORSPACE_IS_ICC;
    enum FZ_COLORSPACE_HAS_CMYK = _Anonymous_10.FZ_COLORSPACE_HAS_CMYK;
    enum FZ_COLORSPACE_HAS_SPOTS = _Anonymous_10.FZ_COLORSPACE_HAS_SPOTS;
    enum FZ_COLORSPACE_HAS_CMYK_AND_SPOTS = _Anonymous_10.FZ_COLORSPACE_HAS_CMYK_AND_SPOTS;
    /**
...
*/
    ...
    alias fz_deflate_level = _Anonymous_11;
    ...
    enum FZ_DEFLATE_NONE = _Anonymous_11.FZ_DEFLATE_NONE;
    enum FZ_DEFLATE_BEST_SPEED = _Anonymous_11.FZ_DEFLATE_BEST_SPEED;
    enum FZ_DEFLATE_BEST = _Anonymous_11.FZ_DEFLATE_BEST;
    enum FZ_DEFLATE_DEFAULT = _Anonymous_11.FZ_DEFLATE_DEFAULT;
    /**
...
*/
    ...
    enum FZ_IMAGE_UNKNOWN = _Anonymous_19.FZ_IMAGE_UNKNOWN;
    enum FZ_IMAGE_RAW = _Anonymous_19.FZ_IMAGE_RAW;
    enum FZ_IMAGE_FAX = _Anonymous_19.FZ_IMAGE_FAX;
    enum FZ_IMAGE_FLATE = _Anonymous_19.FZ_IMAGE_FLATE;
    enum FZ_IMAGE_LZW = _Anonymous_19.FZ_IMAGE_LZW;
    enum FZ_IMAGE_RLD = _Anonymous_19.FZ_IMAGE_RLD;
    enum FZ_IMAGE_BMP = _Anonymous_19.FZ_IMAGE_BMP;
    enum FZ_IMAGE_GIF = _Anonymous_19.FZ_IMAGE_GIF;
    enum FZ_IMAGE_JBIG2 = _Anonymous_19.FZ_IMAGE_JBIG2;
    enum FZ_IMAGE_JPEG = _Anonymous_19.FZ_IMAGE_JPEG;
    enum FZ_IMAGE_JPX = _Anonymous_19.FZ_IMAGE_JPX;
    enum FZ_IMAGE_JXR = _Anonymous_19.FZ_IMAGE_JXR;
    enum FZ_IMAGE_PNG = _Anonymous_19.FZ_IMAGE_PNG;
    enum FZ_IMAGE_PNM = _Anonymous_19.FZ_IMAGE_PNM;
    enum FZ_IMAGE_TIFF = _Anonymous_19.FZ_IMAGE_TIFF;
    /**
...
*/
    ...
    struct __pthread_cond_s
    {
        ...
        _Anonymous_20 _anonymous_22;
        ref auto __wseq() @property @nogc pure nothrow { return _anonymous_22.__wseq; }
        void __wseq(_T_)(auto ref _T_ val) @property @nogc pure nothrow { _anonymous_22.__wseq = val; }
        ref auto __wseq32() @property @nogc pure nothrow { return _anonymous_22.__wseq32; }
        void __wseq32(_T_)(auto ref _T_ val) @property @nogc pure nothrow { _anonymous_22.__wseq32 = val; }
        ...
        static union _Anonymous_23
        {
            ...
            _Anonymous_24 __g1_start32;
        }
        _Anonymous_23 _anonymous_25;
        ref auto __g1_start() @property @nogc pure nothrow { return _anonymous_25.__g1_start; }
        void __g1_start(_T_)(auto ref _T_ val) @property @nogc pure nothrow { _anonymous_25.__g1_start = val; }
        ref auto __g1_start32() @property @nogc pure nothrow { return _anonymous_25.__g1_start32; }
        void __g1_start32(_T_)(auto ref _T_ val) @property @nogc pure nothrow { _anonymous_25.__g1_start32 = val; }
...
*/
    ...
    enum FZ_ERROR_NONE = _Anonymous_26.FZ_ERROR_NONE;
    enum FZ_ERROR_MEMORY = _Anonymous_26.FZ_ERROR_MEMORY;
    enum FZ_ERROR_GENERIC = _Anonymous_26.FZ_ERROR_GENERIC;
    enum FZ_ERROR_SYNTAX = _Anonymous_26.FZ_ERROR_SYNTAX;
    enum FZ_ERROR_MINOR = _Anonymous_26.FZ_ERROR_MINOR;
    enum FZ_ERROR_TRYLATER = _Anonymous_26.FZ_ERROR_TRYLATER;
    enum FZ_ERROR_ABORT = _Anonymous_26.FZ_ERROR_ABORT;
    enum FZ_ERROR_REPAIRED = _Anonymous_26.FZ_ERROR_REPAIRED;
    enum FZ_ERROR_COUNT = _Anonymous_26.FZ_ERROR_COUNT;
    /**
...
*/
    ...
    enum FZ_LOCK_ALLOC = _Anonymous_27.FZ_LOCK_ALLOC;
    enum FZ_LOCK_FREETYPE = _Anonymous_27.FZ_LOCK_FREETYPE;
    enum FZ_LOCK_GLYPHCACHE = _Anonymous_27.FZ_LOCK_GLYPHCACHE;
    enum FZ_LOCK_MAX = _Anonymous_27.FZ_LOCK_MAX;
...
*/
    ...
    enum FZ_STORE_UNLIMITED = _Anonymous_28.FZ_STORE_UNLIMITED;
    enum FZ_STORE_DEFAULT = _Anonymous_28.FZ_STORE_DEFAULT;
    /**
...
*/
    static void fz_lock(fz_context*, int) @nogc nothrow;
    /**
	Unlock one of the user supplied mutexes.
*/
    static void fz_unlock(fz_context*, int) @nogc nothrow;

    static void* fz_keep_imp(fz_context*, void*, int*) @nogc nothrow;

    static void* fz_keep_imp_locked(fz_context*, void*, int*) @nogc nothrow;

    static void* fz_keep_imp8(fz_context*, void*, byte*) @nogc nothrow;

    static void* fz_keep_imp16(fz_context*, void*, short*) @nogc nothrow;

    static int fz_drop_imp(fz_context*, void*, int*) @nogc nothrow;

    static int fz_drop_imp8(fz_context*, void*, byte*) @nogc nothrow;

    static int fz_drop_imp16(fz_context*, void*, short*) @nogc nothrow;
...
*/
    ...
    enum FZ_DEVFLAG_MASK = _Anonymous_31.FZ_DEVFLAG_MASK;
    enum FZ_DEVFLAG_COLOR = _Anonymous_31.FZ_DEVFLAG_COLOR;
    enum FZ_DEVFLAG_UNCACHEABLE = _Anonymous_31.FZ_DEVFLAG_UNCACHEABLE;
    enum FZ_DEVFLAG_FILLCOLOR_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_FILLCOLOR_UNDEFINED;
    enum FZ_DEVFLAG_STROKECOLOR_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_STROKECOLOR_UNDEFINED;
    enum FZ_DEVFLAG_STARTCAP_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_STARTCAP_UNDEFINED;
    enum FZ_DEVFLAG_DASHCAP_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_DASHCAP_UNDEFINED;
    enum FZ_DEVFLAG_ENDCAP_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_ENDCAP_UNDEFINED;
    enum FZ_DEVFLAG_LINEJOIN_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_LINEJOIN_UNDEFINED;
    enum FZ_DEVFLAG_MITERLIMIT_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_MITERLIMIT_UNDEFINED;
    enum FZ_DEVFLAG_LINEWIDTH_UNDEFINED = _Anonymous_31.FZ_DEVFLAG_LINEWIDTH_UNDEFINED;
    enum FZ_DEVFLAG_BBOX_DEFINED = _Anonymous_31.FZ_DEVFLAG_BBOX_DEFINED;
    enum FZ_DEVFLAG_GRIDFIT_AS_TILED = _Anonymous_31.FZ_DEVFLAG_GRIDFIT_AS_TILED;
    ...
    enum FZ_BLEND_NORMAL = _Anonymous_32.FZ_BLEND_NORMAL;
    enum FZ_BLEND_MULTIPLY = _Anonymous_32.FZ_BLEND_MULTIPLY;
    enum FZ_BLEND_SCREEN = _Anonymous_32.FZ_BLEND_SCREEN;
    enum FZ_BLEND_OVERLAY = _Anonymous_32.FZ_BLEND_OVERLAY;
    enum FZ_BLEND_DARKEN = _Anonymous_32.FZ_BLEND_DARKEN;
    enum FZ_BLEND_LIGHTEN = _Anonymous_32.FZ_BLEND_LIGHTEN;
    enum FZ_BLEND_COLOR_DODGE = _Anonymous_32.FZ_BLEND_COLOR_DODGE;
    enum FZ_BLEND_COLOR_BURN = _Anonymous_32.FZ_BLEND_COLOR_BURN;
    enum FZ_BLEND_HARD_LIGHT = _Anonymous_32.FZ_BLEND_HARD_LIGHT;
    enum FZ_BLEND_SOFT_LIGHT = _Anonymous_32.FZ_BLEND_SOFT_LIGHT;
    enum FZ_BLEND_DIFFERENCE = _Anonymous_32.FZ_BLEND_DIFFERENCE;
    enum FZ_BLEND_EXCLUSION = _Anonymous_32.FZ_BLEND_EXCLUSION;
    enum FZ_BLEND_HUE = _Anonymous_32.FZ_BLEND_HUE;
    enum FZ_BLEND_SATURATION = _Anonymous_32.FZ_BLEND_SATURATION;
    enum FZ_BLEND_COLOR = _Anonymous_32.FZ_BLEND_COLOR;
    enum FZ_BLEND_LUMINOSITY = _Anonymous_32.FZ_BLEND_LUMINOSITY;
    enum FZ_BLEND_MODEMASK = _Anonymous_32.FZ_BLEND_MODEMASK;
    enum FZ_BLEND_ISOLATED = _Anonymous_32.FZ_BLEND_ISOLATED;
    enum FZ_BLEND_KNOCKOUT = _Anonymous_32.FZ_BLEND_KNOCKOUT;
    /**
...
*/
    ...
    enum fz_device_container_stack_is_clip = _Anonymous_33.fz_device_container_stack_is_clip;
    enum fz_device_container_stack_is_mask = _Anonymous_33.fz_device_container_stack_is_mask;
    enum fz_device_container_stack_is_group = _Anonymous_33.fz_device_container_stack_is_group;
    enum fz_device_container_stack_is_tile = _Anonymous_33.fz_device_container_stack_is_tile;
    /**
...
*/
    ...
    enum FZ_DONT_INTERPOLATE_IMAGES = _Anonymous_34.FZ_DONT_INTERPOLATE_IMAGES;
    enum FZ_NO_CACHE = _Anonymous_34.FZ_NO_CACHE;
    /**
...
*/
    ...
    enum FZ_TEST_OPT_IMAGES = _Anonymous_35.FZ_TEST_OPT_IMAGES;
    enum FZ_TEST_OPT_SHADINGS = _Anonymous_35.FZ_TEST_OPT_SHADINGS;
    /**
...
*/
    struct fz_document
    {
        ...
        fz_location function(fz_context*, fz_document*, const(char)*, float*, float*) resolve_link;
...
*/
    static fz_location fz_make_location(int, int) @nogc nothrow;
    ...
    enum FZ_LAYOUT_KINDLE_W = _Anonymous_36.FZ_LAYOUT_KINDLE_W;
    enum FZ_LAYOUT_KINDLE_H = _Anonymous_36.FZ_LAYOUT_KINDLE_H;
    enum FZ_LAYOUT_KINDLE_EM = _Anonymous_36.FZ_LAYOUT_KINDLE_EM;
    enum FZ_LAYOUT_US_POCKET_W = _Anonymous_36.FZ_LAYOUT_US_POCKET_W;
    enum FZ_LAYOUT_US_POCKET_H = _Anonymous_36.FZ_LAYOUT_US_POCKET_H;
    enum FZ_LAYOUT_US_POCKET_EM = _Anonymous_36.FZ_LAYOUT_US_POCKET_EM;
    enum FZ_LAYOUT_US_TRADE_W = _Anonymous_36.FZ_LAYOUT_US_TRADE_W;
    enum FZ_LAYOUT_US_TRADE_H = _Anonymous_36.FZ_LAYOUT_US_TRADE_H;
    enum FZ_LAYOUT_US_TRADE_EM = _Anonymous_36.FZ_LAYOUT_US_TRADE_EM;
    enum FZ_LAYOUT_UK_A_FORMAT_W = _Anonymous_36.FZ_LAYOUT_UK_A_FORMAT_W;
    enum FZ_LAYOUT_UK_A_FORMAT_H = _Anonymous_36.FZ_LAYOUT_UK_A_FORMAT_H;
    enum FZ_LAYOUT_UK_A_FORMAT_EM = _Anonymous_36.FZ_LAYOUT_UK_A_FORMAT_EM;
    enum FZ_LAYOUT_UK_B_FORMAT_W = _Anonymous_36.FZ_LAYOUT_UK_B_FORMAT_W;
    enum FZ_LAYOUT_UK_B_FORMAT_H = _Anonymous_36.FZ_LAYOUT_UK_B_FORMAT_H;
    enum FZ_LAYOUT_UK_B_FORMAT_EM = _Anonymous_36.FZ_LAYOUT_UK_B_FORMAT_EM;
    enum FZ_LAYOUT_UK_C_FORMAT_W = _Anonymous_36.FZ_LAYOUT_UK_C_FORMAT_W;
    enum FZ_LAYOUT_UK_C_FORMAT_H = _Anonymous_36.FZ_LAYOUT_UK_C_FORMAT_H;
    enum FZ_LAYOUT_UK_C_FORMAT_EM = _Anonymous_36.FZ_LAYOUT_UK_C_FORMAT_EM;
    enum FZ_LAYOUT_A5_W = _Anonymous_36.FZ_LAYOUT_A5_W;
    enum FZ_LAYOUT_A5_H = _Anonymous_36.FZ_LAYOUT_A5_H;
    enum FZ_LAYOUT_A5_EM = _Anonymous_36.FZ_LAYOUT_A5_EM;
    enum FZ_DEFAULT_LAYOUT_W = _Anonymous_36.FZ_DEFAULT_LAYOUT_W;
    enum FZ_DEFAULT_LAYOUT_H = _Anonymous_36.FZ_DEFAULT_LAYOUT_H;
    enum FZ_DEFAULT_LAYOUT_EM = _Anonymous_36.FZ_DEFAULT_LAYOUT_EM;

    alias fz_permission = _Anonymous_37;
    ...
    enum FZ_PERMISSION_PRINT = _Anonymous_37.FZ_PERMISSION_PRINT;
    enum FZ_PERMISSION_COPY = _Anonymous_37.FZ_PERMISSION_COPY;
    enum FZ_PERMISSION_EDIT = _Anonymous_37.FZ_PERMISSION_EDIT;
    enum FZ_PERMISSION_ANNOTATE = _Anonymous_37.FZ_PERMISSION_ANNOTATE;
    ...
    alias fz_document_resolve_link_fn = fz_location function(fz_context*, fz_document*, const(char)*, float*, float*);
...
*/
	...
	substream.
*/
    fz_stream* fz_open_null_filter(fz_context*, fz_stream*, int, c_long) @nogc nothrow;
    /**
...
*/
    fz_stream* fz_open_endstream_filter(fz_context*, fz_stream*, int, c_long) @nogc nothrow;
    /**
...
*/
    ...
    enum FZ_ADOBE_CNS = _Anonymous_38.FZ_ADOBE_CNS;
    enum FZ_ADOBE_GB = _Anonymous_38.FZ_ADOBE_GB;
    enum FZ_ADOBE_JAPAN = _Anonymous_38.FZ_ADOBE_JAPAN;
    enum FZ_ADOBE_KOREA = _Anonymous_38.FZ_ADOBE_KOREA;
    /**
...
*/
    static int fz_mul255(int, int) @nogc nothrow;
    /**
	Undo alpha premultiplication.
*/
    static int fz_div255(int, int) @nogc nothrow;
    /**
	Range checking atof
*/
...
*/
    static float fz_abs(float) @nogc nothrow;

    static int fz_absi(int) @nogc nothrow;

    static float fz_min(float, float) @nogc nothrow;

    static int fz_mini(int, int) @nogc nothrow;

    static c_ulong fz_minz(c_ulong, c_ulong) @nogc nothrow;

    static float fz_max(float, float) @nogc nothrow;

    static int fz_maxi(int, int) @nogc nothrow;

    static c_ulong fz_maxz(c_ulong, c_ulong) @nogc nothrow;

    static c_long fz_maxi64(c_long, c_long) @nogc nothrow;

    static float fz_clamp(float, float, float) @nogc nothrow;

    static int fz_clampi(int, int, int) @nogc nothrow;

    static double fz_clampd(double, double, double) @nogc nothrow;

    static void* fz_clampp(void*, void*, void*) @nogc nothrow;
    /**
...
*/
    ...
    static fz_point fz_make_point(float, float) @nogc nothrow;
    ...
    static fz_rect fz_make_rect(float, float, float, float) @nogc nothrow;
    /**
...
*/
    ...
    static fz_irect fz_make_irect(int, int, int, int) @nogc nothrow;
    /**
...
*/
    static int fz_is_empty_rect(fz_rect) @nogc nothrow;

    static int fz_is_empty_irect(fz_irect) @nogc nothrow;
    /**
	Check if rectangle is infinite.
*/
    static int fz_is_infinite_rect(fz_rect) @nogc nothrow;
    /**
	Check if an integer rectangle
	is infinite.
*/
    static int fz_is_infinite_irect(fz_irect) @nogc nothrow;
    /**
	Check if rectangle is valid.
*/
    static int fz_is_valid_rect(fz_rect) @nogc nothrow;
    /**
	Check if an integer rectangle is valid.
*/
    static int fz_is_valid_irect(fz_irect) @nogc nothrow;
    /**
	Return the width of an irect. Invalid irects return 0.
*/
    static uint fz_irect_width(fz_irect) @nogc nothrow;
    /**
	Return the height of an irect. Invalid irects return 0.
*/
    static int fz_irect_height(fz_irect) @nogc nothrow;
    /**
...
*/
    ...
    static fz_matrix fz_make_matrix(float, float, float, float, float, float) @nogc nothrow;

    static int fz_is_identity(fz_matrix) @nogc nothrow;
    /**
...
*/
    static fz_quad fz_make_quad(float, float, float, float, float, float, float, float) @nogc nothrow;
    /**
...
*/
	...
	Internal function.
*/
    fz_link* fz_new_link(fz_context*, fz_rect, const(char)*) @nogc nothrow;
    /**
...
*/
    ...
    enum FZ_SVG_TEXT_AS_PATH = _Anonymous_39.FZ_SVG_TEXT_AS_PATH;
    enum FZ_SVG_TEXT_AS_TEXT = _Anonymous_39.FZ_SVG_TEXT_AS_TEXT;
    /**
...
*/
    ...
    alias fz_linecap = _Anonymous_40;
    ...
    enum FZ_LINECAP_BUTT = _Anonymous_40.FZ_LINECAP_BUTT;
    enum FZ_LINECAP_ROUND = _Anonymous_40.FZ_LINECAP_ROUND;
    enum FZ_LINECAP_SQUARE = _Anonymous_40.FZ_LINECAP_SQUARE;
    enum FZ_LINECAP_TRIANGLE = _Anonymous_40.FZ_LINECAP_TRIANGLE;

    alias fz_linejoin = _Anonymous_41;
    ...
    enum FZ_LINEJOIN_MITER = _Anonymous_41.FZ_LINEJOIN_MITER;
    enum FZ_LINEJOIN_ROUND = _Anonymous_41.FZ_LINEJOIN_ROUND;
    enum FZ_LINEJOIN_BEVEL = _Anonymous_41.FZ_LINEJOIN_BEVEL;
    enum FZ_LINEJOIN_MITER_XPS = _Anonymous_41.FZ_LINEJOIN_MITER_XPS;
...
*/
    ...
    enum FZ_PIXMAP_FLAG_INTERPOLATE = _Anonymous_42.FZ_PIXMAP_FLAG_INTERPOLATE;
    enum FZ_PIXMAP_FLAG_FREE_SAMPLES = _Anonymous_42.FZ_PIXMAP_FLAG_FREE_SAMPLES;
...
*/
    ...
    enum FZ_MAX_SEPARATIONS = _Anonymous_43.FZ_MAX_SEPARATIONS;
    struct fz_separations;

    alias fz_separation_behavior = _Anonymous_44;
    ...
    enum FZ_SEPARATION_COMPOSITE = _Anonymous_44.FZ_SEPARATION_COMPOSITE;
    enum FZ_SEPARATION_SPOT = _Anonymous_44.FZ_SEPARATION_SPOT;
    enum FZ_SEPARATION_DISABLED = _Anonymous_44.FZ_SEPARATION_DISABLED;
    /**
 ...
 */
    ...
    enum FZ_FUNCTION_BASED = _Anonymous_45.FZ_FUNCTION_BASED;
    enum FZ_LINEAR = _Anonymous_45.FZ_LINEAR;
    enum FZ_RADIAL = _Anonymous_45.FZ_RADIAL;
    enum FZ_MESH_TYPE4 = _Anonymous_45.FZ_MESH_TYPE4;
    enum FZ_MESH_TYPE5 = _Anonymous_45.FZ_MESH_TYPE5;
    enum FZ_MESH_TYPE6 = _Anonymous_45.FZ_MESH_TYPE6;
    enum FZ_MESH_TYPE7 = _Anonymous_45.FZ_MESH_TYPE7;
    /**
...
*/
    fz_buffer* fz_read_best(fz_context*, fz_stream*, c_ulong, int*) @nogc nothrow;
    /**
...
*/
    static c_ulong fz_available(fz_context*, fz_stream*, c_ulong) @nogc nothrow;
    /**
	...
	throw exceptions.
*/
    static int fz_read_byte(fz_context*, fz_stream*) @nogc nothrow;
    /**
...
*/
    static int fz_peek_byte(fz_context*, fz_stream*) @nogc nothrow;
    /**
...
*/
    static void fz_unread_byte(fz_context*, fz_stream*) @nogc nothrow;
    /**
	...
	reading.
*/
    static int fz_is_eof(fz_context*, fz_stream*) @nogc nothrow;
    /**
...
*/
    static uint fz_read_bits(fz_context*, fz_stream*, int) @nogc nothrow;
    /**
	Read the next n bits from a stream (assumed to
...
*/
    static uint fz_read_rbits(fz_context*, fz_stream*, int) @nogc nothrow;
    /**
...
*/
    static void fz_sync_bits(fz_context*, fz_stream*) @nogc nothrow;
    /**
	...
	reading.
*/
    static int fz_is_eof_bits(fz_context*, fz_stream*) @nogc nothrow;
    /**
...
*/
    ...
    enum FZ_UTFMAX = _Anonymous_55.FZ_UTFMAX;
    /**
...
*/
    ...
    enum FZ_STEXT_PRESERVE_LIGATURES = _Anonymous_59.FZ_STEXT_PRESERVE_LIGATURES;
    enum FZ_STEXT_PRESERVE_WHITESPACE = _Anonymous_59.FZ_STEXT_PRESERVE_WHITESPACE;
    enum FZ_STEXT_PRESERVE_IMAGES = _Anonymous_59.FZ_STEXT_PRESERVE_IMAGES;
    enum FZ_STEXT_INHIBIT_SPACES = _Anonymous_59.FZ_STEXT_INHIBIT_SPACES;
    enum FZ_STEXT_DEHYPHENATE = _Anonymous_59.FZ_STEXT_DEHYPHENATE;
    enum FZ_STEXT_PRESERVE_SPANS = _Anonymous_59.FZ_STEXT_PRESERVE_SPANS;
    enum FZ_STEXT_MEDIABOX_CLIP = _Anonymous_59.FZ_STEXT_MEDIABOX_CLIP;
    /**
...
*/
    ...
    enum FZ_STEXT_BLOCK_TEXT = _Anonymous_60.FZ_STEXT_BLOCK_TEXT;
    enum FZ_STEXT_BLOCK_IMAGE = _Anonymous_60.FZ_STEXT_BLOCK_IMAGE;
...
*/
	...
	without notice.
*/
    int fz_search_stext_page(fz_context*, fz_stext_page*, const(char)*, fz_quad*, int) @nogc nothrow;
    /**
...
*/
    ...
    enum FZ_SELECT_CHARS = _Anonymous_61.FZ_SELECT_CHARS;
    enum FZ_SELECT_WORDS = _Anonymous_61.FZ_SELECT_WORDS;
    enum FZ_SELECT_LINES = _Anonymous_61.FZ_SELECT_LINES;
...
*/
	...
	function.
*/
    fz_device* fz_new_ocr_device(fz_context*, fz_device*, fz_matrix, fz_rect, int, const(char)*, int function(fz_context*, void*, int), void*) @nogc nothrow;
    ...
    static int fz_is_pow2(int) @nogc nothrow;
    /**
	Text buffer.
...
*/
    ...
    alias fz_text_language = _Anonymous_62;
    ...
    enum FZ_LANG_UNSET = _Anonymous_62.FZ_LANG_UNSET;
    enum FZ_LANG_ur = _Anonymous_62.FZ_LANG_ur;
    enum FZ_LANG_urd = _Anonymous_62.FZ_LANG_urd;
    enum FZ_LANG_ko = _Anonymous_62.FZ_LANG_ko;
    enum FZ_LANG_ja = _Anonymous_62.FZ_LANG_ja;
    enum FZ_LANG_zh = _Anonymous_62.FZ_LANG_zh;
    enum FZ_LANG_zh_Hans = _Anonymous_62.FZ_LANG_zh_Hans;
    enum FZ_LANG_zh_Hant = _Anonymous_62.FZ_LANG_zh_Hant;
...
*/
    ...
    enum FZ_TRANSITION_NONE = _Anonymous_63.FZ_TRANSITION_NONE;
    enum FZ_TRANSITION_SPLIT = _Anonymous_63.FZ_TRANSITION_SPLIT;
    enum FZ_TRANSITION_BLINDS = _Anonymous_63.FZ_TRANSITION_BLINDS;
    enum FZ_TRANSITION_BOX = _Anonymous_63.FZ_TRANSITION_BOX;
    enum FZ_TRANSITION_WIPE = _Anonymous_63.FZ_TRANSITION_WIPE;
    enum FZ_TRANSITION_DISSOLVE = _Anonymous_63.FZ_TRANSITION_DISSOLVE;
    enum FZ_TRANSITION_GLITTER = _Anonymous_63.FZ_TRANSITION_GLITTER;
    enum FZ_TRANSITION_FLY = _Anonymous_63.FZ_TRANSITION_FLY;
    enum FZ_TRANSITION_PUSH = _Anonymous_63.FZ_TRANSITION_PUSH;
    enum FZ_TRANSITION_COVER = _Anonymous_63.FZ_TRANSITION_COVER;
    enum FZ_TRANSITION_UNCOVER = _Anonymous_63.FZ_TRANSITION_UNCOVER;
    enum FZ_TRANSITION_FADE = _Anonymous_63.FZ_TRANSITION_FADE;
...
*/
    int fz_search_page(fz_context*, fz_page*, const(char)*, fz_quad*, int) @nogc nothrow;

    int fz_search_page_number(fz_context*, fz_document*, int, const(char)*, fz_quad*, int) @nogc nothrow;

    int fz_search_chapter_page_number(fz_context*, fz_document*, int, int, const(char)*, fz_quad*, int) @nogc nothrow;

    int fz_search_display_list(fz_context*, fz_display_list*, const(char)*, fz_quad*, int) @nogc nothrow;
    /**
...
*/
    void fz_pdfocr_band_writer_set_progress(fz_context*, fz_band_writer*, int function(fz_context*, void*, int), void*) @nogc nothrow;
    /**
...
*/
    ...
    void fz_pdfocr_writer_set_progress(fz_context*, fz_document_writer*, int function(fz_context*, void*, int), void*) @nogc nothrow;
...
*/
    fz_xml_doc* fz_parse_xml(fz_context*, fz_buffer*, int) @nogc nothrow;
    /**
	Parse the contents of a buffer into a tree of XML nodes,
	using the HTML5 parsing algorithm.
*/
    fz_xml_doc* fz_parse_xml_from_html5(fz_context*, fz_buffer*) @nogc nothrow;
    /**
	Free the XML node and all its children and siblings.
*/
    void fz_drop_xml(fz_context*, fz_xml_doc*) @nogc nothrow;
    /**
	Detach a node from the tree, unlinking it from its parent,
	and setting the document root to the node.
*/
    void fz_detach_xml(fz_context*, fz_xml_doc*, fz_xml*) @nogc nothrow;
    /**
...
*/
    ...
    enum PDF_ANNOT_IS_INVISIBLE = _Anonymous_64.PDF_ANNOT_IS_INVISIBLE;
    enum PDF_ANNOT_IS_HIDDEN = _Anonymous_64.PDF_ANNOT_IS_HIDDEN;
    enum PDF_ANNOT_IS_PRINT = _Anonymous_64.PDF_ANNOT_IS_PRINT;
    enum PDF_ANNOT_IS_NO_ZOOM = _Anonymous_64.PDF_ANNOT_IS_NO_ZOOM;
    enum PDF_ANNOT_IS_NO_ROTATE = _Anonymous_64.PDF_ANNOT_IS_NO_ROTATE;
    enum PDF_ANNOT_IS_NO_VIEW = _Anonymous_64.PDF_ANNOT_IS_NO_VIEW;
    enum PDF_ANNOT_IS_READ_ONLY = _Anonymous_64.PDF_ANNOT_IS_READ_ONLY;
    enum PDF_ANNOT_IS_LOCKED = _Anonymous_64.PDF_ANNOT_IS_LOCKED;
    enum PDF_ANNOT_IS_TOGGLE_NO_VIEW = _Anonymous_64.PDF_ANNOT_IS_TOGGLE_NO_VIEW;
    enum PDF_ANNOT_IS_LOCKED_CONTENTS = _Anonymous_64.PDF_ANNOT_IS_LOCKED_CONTENTS;
    ...
    enum PDF_ANNOT_Q_LEFT = _Anonymous_65.PDF_ANNOT_Q_LEFT;
    enum PDF_ANNOT_Q_CENTER = _Anonymous_65.PDF_ANNOT_Q_CENTER;
    enum PDF_ANNOT_Q_RIGHT = _Anonymous_65.PDF_ANNOT_Q_RIGHT;
    ...
    const(char)* pdf_guess_mime_type_from_file_name(fz_context*, const(char)*) @nogc nothrow;

    pdf_obj* pdf_embedded_file_stream(fz_context*, pdf_obj*) @nogc nothrow;

    const(char)* pdf_embedded_file_name(fz_context*, pdf_obj*) @nogc nothrow;

    const(char)* pdf_embedded_file_type(fz_context*, pdf_obj*) @nogc nothrow;

    int pdf_is_embedded_file(fz_context*, pdf_obj*) @nogc nothrow;

    fz_buffer* pdf_load_embedded_file(fz_context*, pdf_obj*) @nogc nothrow;

    pdf_obj* pdf_add_embedded_file(fz_context*, pdf_document*, const(char)*, const(char)*, fz_buffer*) @nogc nothrow;
    ...
    fz_link* pdf_load_link_annots(fz_context*, pdf_document*, pdf_obj*, int, fz_matrix) @nogc nothrow;
    ...
    enum PDF_ENCRYPT_KEEP = _Anonymous_67.PDF_ENCRYPT_KEEP;
    enum PDF_ENCRYPT_NONE = _Anonymous_67.PDF_ENCRYPT_NONE;
    enum PDF_ENCRYPT_RC4_40 = _Anonymous_67.PDF_ENCRYPT_RC4_40;
    enum PDF_ENCRYPT_RC4_128 = _Anonymous_67.PDF_ENCRYPT_RC4_128;
    enum PDF_ENCRYPT_AES_128 = _Anonymous_67.PDF_ENCRYPT_AES_128;
    enum PDF_ENCRYPT_AES_256 = _Anonymous_67.PDF_ENCRYPT_AES_256;
    enum PDF_ENCRYPT_UNKNOWN = _Anonymous_67.PDF_ENCRYPT_UNKNOWN;
    ...
    enum PDF_PERM_PRINT = _Anonymous_68.PDF_PERM_PRINT;
    enum PDF_PERM_MODIFY = _Anonymous_68.PDF_PERM_MODIFY;
    enum PDF_PERM_COPY = _Anonymous_68.PDF_PERM_COPY;
    enum PDF_PERM_ANNOTATE = _Anonymous_68.PDF_PERM_ANNOTATE;
    enum PDF_PERM_FORM = _Anonymous_68.PDF_PERM_FORM;
    enum PDF_PERM_ACCESSIBILITY = _Anonymous_68.PDF_PERM_ACCESSIBILITY;
    enum PDF_PERM_ASSEMBLE = _Anonymous_68.PDF_PERM_ASSEMBLE;
    enum PDF_PERM_PRINT_HQ = _Anonymous_68.PDF_PERM_PRINT_HQ;
    ...
    enum PDF_LEXBUF_SMALL = _Anonymous_69.PDF_LEXBUF_SMALL;
    enum PDF_LEXBUF_LARGE = _Anonymous_69.PDF_LEXBUF_LARGE;
    ...
    alias pdf_layer_config_ui_type = _Anonymous_70;
    ...
    enum PDF_LAYER_UI_LABEL = _Anonymous_70.PDF_LAYER_UI_LABEL;
    enum PDF_LAYER_UI_CHECKBOX = _Anonymous_70.PDF_LAYER_UI_CHECKBOX;
    enum PDF_LAYER_UI_RADIOBOX = _Anonymous_70.PDF_LAYER_UI_RADIOBOX;
    ...
    enum PDF_DOCUMENT_EVENT_ALERT = _Anonymous_71.PDF_DOCUMENT_EVENT_ALERT;
    enum PDF_DOCUMENT_EVENT_PRINT = _Anonymous_71.PDF_DOCUMENT_EVENT_PRINT;
    enum PDF_DOCUMENT_EVENT_LAUNCH_URL = _Anonymous_71.PDF_DOCUMENT_EVENT_LAUNCH_URL;
    enum PDF_DOCUMENT_EVENT_MAIL_DOC = _Anonymous_71.PDF_DOCUMENT_EVENT_MAIL_DOC;
    enum PDF_DOCUMENT_EVENT_SUBMIT = _Anonymous_71.PDF_DOCUMENT_EVENT_SUBMIT;
    enum PDF_DOCUMENT_EVENT_EXEC_MENU_ITEM = _Anonymous_71.PDF_DOCUMENT_EVENT_EXEC_MENU_ITEM;
    ...
    enum PDF_ALERT_ICON_ERROR = _Anonymous_72.PDF_ALERT_ICON_ERROR;
    enum PDF_ALERT_ICON_WARNING = _Anonymous_72.PDF_ALERT_ICON_WARNING;
    enum PDF_ALERT_ICON_QUESTION = _Anonymous_72.PDF_ALERT_ICON_QUESTION;
    enum PDF_ALERT_ICON_STATUS = _Anonymous_72.PDF_ALERT_ICON_STATUS;
    ...
    enum PDF_ALERT_BUTTON_GROUP_OK = _Anonymous_73.PDF_ALERT_BUTTON_GROUP_OK;
    enum PDF_ALERT_BUTTON_GROUP_OK_CANCEL = _Anonymous_73.PDF_ALERT_BUTTON_GROUP_OK_CANCEL;
    enum PDF_ALERT_BUTTON_GROUP_YES_NO = _Anonymous_73.PDF_ALERT_BUTTON_GROUP_YES_NO;
    enum PDF_ALERT_BUTTON_GROUP_YES_NO_CANCEL = _Anonymous_73.PDF_ALERT_BUTTON_GROUP_YES_NO_CANCEL;
    ...
    enum PDF_ALERT_BUTTON_NONE = _Anonymous_74.PDF_ALERT_BUTTON_NONE;
    enum PDF_ALERT_BUTTON_OK = _Anonymous_74.PDF_ALERT_BUTTON_OK;
    enum PDF_ALERT_BUTTON_CANCEL = _Anonymous_74.PDF_ALERT_BUTTON_CANCEL;
    enum PDF_ALERT_BUTTON_NO = _Anonymous_74.PDF_ALERT_BUTTON_NO;
    enum PDF_ALERT_BUTTON_YES = _Anonymous_74.PDF_ALERT_BUTTON_YES;
    ...
    enum PDF_FD_FIXED_PITCH = _Anonymous_75.PDF_FD_FIXED_PITCH;
    enum PDF_FD_SERIF = _Anonymous_75.PDF_FD_SERIF;
    enum PDF_FD_SYMBOLIC = _Anonymous_75.PDF_FD_SYMBOLIC;
    enum PDF_FD_SCRIPT = _Anonymous_75.PDF_FD_SCRIPT;
    enum PDF_FD_NONSYMBOLIC = _Anonymous_75.PDF_FD_NONSYMBOLIC;
    enum PDF_FD_ITALIC = _Anonymous_75.PDF_FD_ITALIC;
    enum PDF_FD_ALL_CAP = _Anonymous_75.PDF_FD_ALL_CAP;
    enum PDF_FD_SMALL_CAP = _Anonymous_75.PDF_FD_SMALL_CAP;
    enum PDF_FD_FORCE_BOLD = _Anonymous_75.PDF_FD_FORCE_BOLD;
    ...
    enum PDF_FIELD_IS_READ_ONLY = _Anonymous_76.PDF_FIELD_IS_READ_ONLY;
    enum PDF_FIELD_IS_REQUIRED = _Anonymous_76.PDF_FIELD_IS_REQUIRED;
    enum PDF_FIELD_IS_NO_EXPORT = _Anonymous_76.PDF_FIELD_IS_NO_EXPORT;
    enum PDF_TX_FIELD_IS_MULTILINE = _Anonymous_76.PDF_TX_FIELD_IS_MULTILINE;
    enum PDF_TX_FIELD_IS_PASSWORD = _Anonymous_76.PDF_TX_FIELD_IS_PASSWORD;
    enum PDF_TX_FIELD_IS_FILE_SELECT = _Anonymous_76.PDF_TX_FIELD_IS_FILE_SELECT;
    enum PDF_TX_FIELD_IS_DO_NOT_SPELL_CHECK = _Anonymous_76.PDF_TX_FIELD_IS_DO_NOT_SPELL_CHECK;
    enum PDF_TX_FIELD_IS_DO_NOT_SCROLL = _Anonymous_76.PDF_TX_FIELD_IS_DO_NOT_SCROLL;
    enum PDF_TX_FIELD_IS_COMB = _Anonymous_76.PDF_TX_FIELD_IS_COMB;
    enum PDF_TX_FIELD_IS_RICH_TEXT = _Anonymous_76.PDF_TX_FIELD_IS_RICH_TEXT;
    enum PDF_BTN_FIELD_IS_NO_TOGGLE_TO_OFF = _Anonymous_76.PDF_BTN_FIELD_IS_NO_TOGGLE_TO_OFF;
    enum PDF_BTN_FIELD_IS_RADIO = _Anonymous_76.PDF_BTN_FIELD_IS_RADIO;
    enum PDF_BTN_FIELD_IS_PUSHBUTTON = _Anonymous_76.PDF_BTN_FIELD_IS_PUSHBUTTON;
    enum PDF_BTN_FIELD_IS_RADIOS_IN_UNISON = _Anonymous_76.PDF_BTN_FIELD_IS_RADIOS_IN_UNISON;
    enum PDF_CH_FIELD_IS_COMBO = _Anonymous_76.PDF_CH_FIELD_IS_COMBO;
    enum PDF_CH_FIELD_IS_EDIT = _Anonymous_76.PDF_CH_FIELD_IS_EDIT;
    enum PDF_CH_FIELD_IS_SORT = _Anonymous_76.PDF_CH_FIELD_IS_SORT;
    enum PDF_CH_FIELD_IS_MULTI_SELECT = _Anonymous_76.PDF_CH_FIELD_IS_MULTI_SELECT;
    enum PDF_CH_FIELD_IS_DO_NOT_SPELL_CHECK = _Anonymous_76.PDF_CH_FIELD_IS_DO_NOT_SPELL_CHECK;
    enum PDF_CH_FIELD_IS_COMMIT_ON_SEL_CHANGE = _Anonymous_76.PDF_CH_FIELD_IS_COMMIT_ON_SEL_CHANGE;
    ...
    alias pdf_signature_error = _Anonymous_77;
    ...
    enum PDF_SIGNATURE_ERROR_OKAY = _Anonymous_77.PDF_SIGNATURE_ERROR_OKAY;
    enum PDF_SIGNATURE_ERROR_NO_SIGNATURES = _Anonymous_77.PDF_SIGNATURE_ERROR_NO_SIGNATURES;
    enum PDF_SIGNATURE_ERROR_NO_CERTIFICATE = _Anonymous_77.PDF_SIGNATURE_ERROR_NO_CERTIFICATE;
    enum PDF_SIGNATURE_ERROR_DIGEST_FAILURE = _Anonymous_77.PDF_SIGNATURE_ERROR_DIGEST_FAILURE;
    enum PDF_SIGNATURE_ERROR_SELF_SIGNED = _Anonymous_77.PDF_SIGNATURE_ERROR_SELF_SIGNED;
    enum PDF_SIGNATURE_ERROR_SELF_SIGNED_IN_CHAIN = _Anonymous_77.PDF_SIGNATURE_ERROR_SELF_SIGNED_IN_CHAIN;
    enum PDF_SIGNATURE_ERROR_NOT_TRUSTED = _Anonymous_77.PDF_SIGNATURE_ERROR_NOT_TRUSTED;
    enum PDF_SIGNATURE_ERROR_UNKNOWN = _Anonymous_77.PDF_SIGNATURE_ERROR_UNKNOWN;
    ...
    enum PDF_SIGNATURE_SHOW_LABELS = _Anonymous_78.PDF_SIGNATURE_SHOW_LABELS;
    enum PDF_SIGNATURE_SHOW_DN = _Anonymous_78.PDF_SIGNATURE_SHOW_DN;
    enum PDF_SIGNATURE_SHOW_DATE = _Anonymous_78.PDF_SIGNATURE_SHOW_DATE;
    enum PDF_SIGNATURE_SHOW_TEXT_NAME = _Anonymous_78.PDF_SIGNATURE_SHOW_TEXT_NAME;
    enum PDF_SIGNATURE_SHOW_GRAPHIC_NAME = _Anonymous_78.PDF_SIGNATURE_SHOW_GRAPHIC_NAME;
    enum PDF_SIGNATURE_SHOW_LOGO = _Anonymous_78.PDF_SIGNATURE_SHOW_LOGO;
    ...
    pdf_obj* pdf_filter_xobject_instance(fz_context*, pdf_obj*, pdf_obj*, fz_matrix, pdf_filter_options*) @nogc nothrow;
    ...
    void pdf_js_execute(pdf_js*, const(char)*, const(char)*) @nogc nothrow;
    ...
    enum _Anonymous_80
    {
        ...
        PDF_ENUM_NAME_BPC = 41,

        PDF_ENUM_NAME_BS = 42,

        PDF_ENUM_NAME_Background = 43,

        PDF_ENUM_NAME_BaseEncoding = 44,

        PDF_ENUM_NAME_BaseFont = 45,

        PDF_ENUM_NAME_BaseState = 46,

        PDF_ENUM_NAME_BitsPerComponent = 47,

        PDF_ENUM_NAME_BitsPerCoordinate = 48,

        PDF_ENUM_NAME_BitsPerFlag = 49,

        PDF_ENUM_NAME_BitsPerSample = 50,

        PDF_ENUM_NAME_BlackIs1 = 51,

        PDF_ENUM_NAME_BlackPoint = 52,

        PDF_ENUM_NAME_BleedBox = 53,

        PDF_ENUM_NAME_Blinds = 54,

        PDF_ENUM_NAME_Border = 55,

        PDF_ENUM_NAME_Bounds = 56,

        PDF_ENUM_NAME_Box = 57,

        PDF_ENUM_NAME_Bt = 58,

        PDF_ENUM_NAME_Btn = 59,

        PDF_ENUM_NAME_Butt = 60,

        PDF_ENUM_NAME_ByteRange = 61,
        ...
        PDF_ENUM_NAME_CCF = 66,

        PDF_ENUM_NAME_CCITTFaxDecode = 67,

        PDF_ENUM_NAME_CF = 68,

        PDF_ENUM_NAME_CFM = 69,

        PDF_ENUM_NAME_CI = 70,

        PDF_ENUM_NAME_CIDFontType0 = 71,

        PDF_ENUM_NAME_CIDFontType0C = 72,

        PDF_ENUM_NAME_CIDFontType2 = 73,

        PDF_ENUM_NAME_CIDSystemInfo = 74,

        PDF_ENUM_NAME_CIDToGIDMap = 75,

        PDF_ENUM_NAME_CMYK = 76,

        PDF_ENUM_NAME_CS = 77,

        PDF_ENUM_NAME_CalCMYK = 78,

        PDF_ENUM_NAME_CalGray = 79,

        PDF_ENUM_NAME_CalRGB = 80,

        PDF_ENUM_NAME_CapHeight = 81,

        PDF_ENUM_NAME_Caret = 82,

        PDF_ENUM_NAME_Catalog = 83,

        PDF_ENUM_NAME_Cert = 84,

        PDF_ENUM_NAME_Ch = 85,

        PDF_ENUM_NAME_Changes = 86,

        PDF_ENUM_NAME_CharProcs = 87,

        PDF_ENUM_NAME_Circle = 88,

        PDF_ENUM_NAME_ClosedArrow = 89,

        PDF_ENUM_NAME_Collection = 90,

        PDF_ENUM_NAME_ColorSpace = 91,

        PDF_ENUM_NAME_ColorTransform = 92,

        PDF_ENUM_NAME_Colorants = 93,

        PDF_ENUM_NAME_Colors = 94,

        PDF_ENUM_NAME_Columns = 95,

        PDF_ENUM_NAME_Confidential = 96,

        PDF_ENUM_NAME_Configs = 97,

        PDF_ENUM_NAME_ContactInfo = 98,

        PDF_ENUM_NAME_Contents = 99,

        PDF_ENUM_NAME_Coords = 100,

        PDF_ENUM_NAME_Count = 101,

        PDF_ENUM_NAME_Cover = 102,

        PDF_ENUM_NAME_CreationDate = 103,

        PDF_ENUM_NAME_Creator = 104,

        PDF_ENUM_NAME_CropBox = 105,

        PDF_ENUM_NAME_Crypt = 106,

        PDF_ENUM_NAME_D = 107,

        PDF_ENUM_NAME_DA = 108,

        PDF_ENUM_NAME_DC = 109,

        PDF_ENUM_NAME_DCT = 110,

        PDF_ENUM_NAME_DCTDecode = 111,

        PDF_ENUM_NAME_DL = 112,

        PDF_ENUM_NAME_DOS = 113,

        PDF_ENUM_NAME_DP = 114,

        PDF_ENUM_NAME_DR = 115,

        PDF_ENUM_NAME_DS = 116,

        PDF_ENUM_NAME_DV = 117,

        PDF_ENUM_NAME_DW = 118,

        PDF_ENUM_NAME_DW2 = 119,

        PDF_ENUM_NAME_DamagedRowsBeforeError = 120,

        PDF_ENUM_NAME_Data = 121,

        PDF_ENUM_NAME_Date = 122,

        PDF_ENUM_NAME_Decode = 123,

        PDF_ENUM_NAME_DecodeParms = 124,

        PDF_ENUM_NAME_Default = 125,

        PDF_ENUM_NAME_DefaultCMYK = 126,

        PDF_ENUM_NAME_DefaultGray = 127,

        PDF_ENUM_NAME_DefaultRGB = 128,

        PDF_ENUM_NAME_Departmental = 129,

        PDF_ENUM_NAME_Desc = 130,

        PDF_ENUM_NAME_DescendantFonts = 131,

        PDF_ENUM_NAME_Descent = 132,

        PDF_ENUM_NAME_Design = 133,

        PDF_ENUM_NAME_Dest = 134,

        PDF_ENUM_NAME_DestOutputProfile = 135,

        PDF_ENUM_NAME_Dests = 136,

        PDF_ENUM_NAME_DeviceCMYK = 137,

        PDF_ENUM_NAME_DeviceGray = 138,

        PDF_ENUM_NAME_DeviceN = 139,

        PDF_ENUM_NAME_DeviceRGB = 140,

        PDF_ENUM_NAME_Di = 141,

        PDF_ENUM_NAME_Diamond = 142,

        PDF_ENUM_NAME_Differences = 143,

        PDF_ENUM_NAME_DigestLocation = 144,

        PDF_ENUM_NAME_DigestMethod = 145,

        PDF_ENUM_NAME_DigestValue = 146,

        PDF_ENUM_NAME_Dissolve = 147,

        PDF_ENUM_NAME_Dm = 148,

        PDF_ENUM_NAME_DocMDP = 149,

        PDF_ENUM_NAME_Document = 150,

        PDF_ENUM_NAME_Domain = 151,

        PDF_ENUM_NAME_Draft = 152,

        PDF_ENUM_NAME_Dur = 153,

        PDF_ENUM_NAME_E = 154,

        PDF_ENUM_NAME_EF = 155,

        PDF_ENUM_NAME_EarlyChange = 156,

        PDF_ENUM_NAME_EmbeddedFile = 157,

        PDF_ENUM_NAME_EmbeddedFiles = 158,

        PDF_ENUM_NAME_Encode = 159,

        PDF_ENUM_NAME_EncodedByteAlign = 160,

        PDF_ENUM_NAME_Encoding = 161,

        PDF_ENUM_NAME_Encrypt = 162,

        PDF_ENUM_NAME_EncryptMetadata = 163,

        PDF_ENUM_NAME_EndOfBlock = 164,

        PDF_ENUM_NAME_EndOfLine = 165,

        PDF_ENUM_NAME_Exclude = 166,

        PDF_ENUM_NAME_Experimental = 167,

        PDF_ENUM_NAME_Expired = 168,

        PDF_ENUM_NAME_ExtGState = 169,

        PDF_ENUM_NAME_Extend = 170,

        PDF_ENUM_NAME_F = 171,

        PDF_ENUM_NAME_FL = 172,

        PDF_ENUM_NAME_FRM = 173,

        PDF_ENUM_NAME_FS = 174,

        PDF_ENUM_NAME_FT = 175,

        PDF_ENUM_NAME_Fade = 176,

        PDF_ENUM_NAME_Ff = 177,

        PDF_ENUM_NAME_FieldMDP = 178,

        PDF_ENUM_NAME_Fields = 179,

        PDF_ENUM_NAME_FileAttachment = 180,

        PDF_ENUM_NAME_FileSize = 181,

        PDF_ENUM_NAME_Filespec = 182,

        PDF_ENUM_NAME_Filter = 183,

        PDF_ENUM_NAME_Final = 184,

        PDF_ENUM_NAME_Fingerprint = 185,

        PDF_ENUM_NAME_First = 186,

        PDF_ENUM_NAME_FirstChar = 187,

        PDF_ENUM_NAME_FirstPage = 188,

        PDF_ENUM_NAME_Fit = 189,

        PDF_ENUM_NAME_FitB = 190,

        PDF_ENUM_NAME_FitBH = 191,

        PDF_ENUM_NAME_FitBV = 192,

        PDF_ENUM_NAME_FitH = 193,

        PDF_ENUM_NAME_FitR = 194,

        PDF_ENUM_NAME_FitV = 195,

        PDF_ENUM_NAME_Fl = 196,

        PDF_ENUM_NAME_Flags = 197,

        PDF_ENUM_NAME_FlateDecode = 198,

        PDF_ENUM_NAME_Fly = 199,

        PDF_ENUM_NAME_Font = 200,

        PDF_ENUM_NAME_FontBBox = 201,

        PDF_ENUM_NAME_FontDescriptor = 202,

        PDF_ENUM_NAME_FontFile = 203,

        PDF_ENUM_NAME_FontFile2 = 204,

        PDF_ENUM_NAME_FontFile3 = 205,

        PDF_ENUM_NAME_FontMatrix = 206,

        PDF_ENUM_NAME_FontName = 207,

        PDF_ENUM_NAME_ForComment = 208,

        PDF_ENUM_NAME_ForPublicRelease = 209,

        PDF_ENUM_NAME_Form = 210,

        PDF_ENUM_NAME_FormEx = 211,

        PDF_ENUM_NAME_FormType = 212,

        PDF_ENUM_NAME_FreeText = 213,

        PDF_ENUM_NAME_Function = 214,

        PDF_ENUM_NAME_FunctionType = 215,

        PDF_ENUM_NAME_Functions = 216,

        PDF_ENUM_NAME_G = 217,

        PDF_ENUM_NAME_Gamma = 218,

        PDF_ENUM_NAME_Glitter = 219,

        PDF_ENUM_NAME_GoTo = 220,

        PDF_ENUM_NAME_GoToR = 221,

        PDF_ENUM_NAME_Group = 222,

        PDF_ENUM_NAME_H = 223,

        PDF_ENUM_NAME_Height = 224,

        PDF_ENUM_NAME_Helv = 225,

        PDF_ENUM_NAME_Highlight = 226,

        PDF_ENUM_NAME_HistoryPos = 227,

        PDF_ENUM_NAME_I = 228,

        PDF_ENUM_NAME_IC = 229,

        PDF_ENUM_NAME_ICCBased = 230,

        PDF_ENUM_NAME_ID = 231,

        PDF_ENUM_NAME_IM = 232,

        PDF_ENUM_NAME_IRT = 233,

        PDF_ENUM_NAME_Identity = 234,

        PDF_ENUM_NAME_Identity_H = 235,

        PDF_ENUM_NAME_Identity_V = 236,

        PDF_ENUM_NAME_Image = 237,

        PDF_ENUM_NAME_ImageMask = 238,

        PDF_ENUM_NAME_Include = 239,

        PDF_ENUM_NAME_Index = 240,

        PDF_ENUM_NAME_Indexed = 241,

        PDF_ENUM_NAME_Info = 242,

        PDF_ENUM_NAME_Ink = 243,

        PDF_ENUM_NAME_InkList = 244,

        PDF_ENUM_NAME_Intent = 245,

        PDF_ENUM_NAME_Interpolate = 246,

        PDF_ENUM_NAME_IsMap = 247,

        PDF_ENUM_NAME_ItalicAngle = 248,

        PDF_ENUM_NAME_JBIG2Decode = 249,

        PDF_ENUM_NAME_JBIG2Globals = 250,

        PDF_ENUM_NAME_JPXDecode = 251,

        PDF_ENUM_NAME_JS = 252,

        PDF_ENUM_NAME_JavaScript = 253,

        PDF_ENUM_NAME_K = 254,

        PDF_ENUM_NAME_Kids = 255,

        PDF_ENUM_NAME_L = 256,

        PDF_ENUM_NAME_LC = 257,

        PDF_ENUM_NAME_LE = 258,

        PDF_ENUM_NAME_LJ = 259,

        PDF_ENUM_NAME_LW = 260,

        PDF_ENUM_NAME_LZ = 261,

        PDF_ENUM_NAME_LZW = 262,

        PDF_ENUM_NAME_LZWDecode = 263,

        PDF_ENUM_NAME_Lab = 264,

        PDF_ENUM_NAME_Lang = 265,

        PDF_ENUM_NAME_Last = 266,

        PDF_ENUM_NAME_LastChar = 267,

        PDF_ENUM_NAME_LastPage = 268,

        PDF_ENUM_NAME_Launch = 269,

        PDF_ENUM_NAME_Length = 270,

        PDF_ENUM_NAME_Length1 = 271,

        PDF_ENUM_NAME_Length2 = 272,

        PDF_ENUM_NAME_Length3 = 273,

        PDF_ENUM_NAME_Limits = 274,

        PDF_ENUM_NAME_Line = 275,

        PDF_ENUM_NAME_Linearized = 276,

        PDF_ENUM_NAME_Link = 277,

        PDF_ENUM_NAME_Location = 278,

        PDF_ENUM_NAME_Lock = 279,

        PDF_ENUM_NAME_Locked = 280,

        PDF_ENUM_NAME_Luminosity = 281,

        PDF_ENUM_NAME_M = 282,

        PDF_ENUM_NAME_MCID = 283,

        PDF_ENUM_NAME_MK = 284,

        PDF_ENUM_NAME_ML = 285,

        PDF_ENUM_NAME_MMType1 = 286,

        PDF_ENUM_NAME_Mac = 287,

        PDF_ENUM_NAME_Mask = 288,

        PDF_ENUM_NAME_Matrix = 289,

        PDF_ENUM_NAME_Matte = 290,

        PDF_ENUM_NAME_MaxLen = 291,

        PDF_ENUM_NAME_MediaBox = 292,

        PDF_ENUM_NAME_Metadata = 293,

        PDF_ENUM_NAME_MissingWidth = 294,

        PDF_ENUM_NAME_ModDate = 295,

        PDF_ENUM_NAME_Movie = 296,

        PDF_ENUM_NAME_Msg = 297,

        PDF_ENUM_NAME_Multiply = 298,

        PDF_ENUM_NAME_N = 299,

        PDF_ENUM_NAME_Name = 300,

        PDF_ENUM_NAME_Named = 301,

        PDF_ENUM_NAME_Names = 302,

        PDF_ENUM_NAME_NewWindow = 303,

        PDF_ENUM_NAME_Next = 304,

        PDF_ENUM_NAME_NextPage = 305,

        PDF_ENUM_NAME_NonEFontNoWarn = 306,

        PDF_ENUM_NAME_None = 307,

        PDF_ENUM_NAME_Normal = 308,

        PDF_ENUM_NAME_NotApproved = 309,

        PDF_ENUM_NAME_NotForPublicRelease = 310,

        PDF_ENUM_NAME_NumSections = 311,

        PDF_ENUM_NAME_Nums = 312,

        PDF_ENUM_NAME_O = 313,

        PDF_ENUM_NAME_OC = 314,

        PDF_ENUM_NAME_OCG = 315,

        PDF_ENUM_NAME_OCGs = 316,

        PDF_ENUM_NAME_OCMD = 317,

        PDF_ENUM_NAME_OCProperties = 318,

        PDF_ENUM_NAME_OE = 319,

        PDF_ENUM_NAME_OFF = 320,

        PDF_ENUM_NAME_ON = 321,

        PDF_ENUM_NAME_OP = 322,

        PDF_ENUM_NAME_OPM = 323,

        PDF_ENUM_NAME_OS = 324,

        PDF_ENUM_NAME_ObjStm = 325,

        PDF_ENUM_NAME_Of = 326,

        PDF_ENUM_NAME_Off = 327,

        PDF_ENUM_NAME_Open = 328,

        PDF_ENUM_NAME_OpenArrow = 329,

        PDF_ENUM_NAME_OpenType = 330,

        PDF_ENUM_NAME_Opt = 331,

        PDF_ENUM_NAME_Order = 332,

        PDF_ENUM_NAME_Ordering = 333,

        PDF_ENUM_NAME_Outlines = 334,

        PDF_ENUM_NAME_OutputIntents = 335,

        PDF_ENUM_NAME_P = 336,

        PDF_ENUM_NAME_PDF = 337,

        PDF_ENUM_NAME_PS = 338,

        PDF_ENUM_NAME_Page = 339,

        PDF_ENUM_NAME_PageMode = 340,

        PDF_ENUM_NAME_Pages = 341,

        PDF_ENUM_NAME_PaintType = 342,

        PDF_ENUM_NAME_Params = 343,

        PDF_ENUM_NAME_Parent = 344,

        PDF_ENUM_NAME_Pattern = 345,

        PDF_ENUM_NAME_PatternType = 346,

        PDF_ENUM_NAME_Perms = 347,

        PDF_ENUM_NAME_PolyLine = 348,

        PDF_ENUM_NAME_Polygon = 349,

        PDF_ENUM_NAME_Popup = 350,

        PDF_ENUM_NAME_PreRelease = 351,

        PDF_ENUM_NAME_Predictor = 352,

        PDF_ENUM_NAME_Prev = 353,

        PDF_ENUM_NAME_PrevPage = 354,

        PDF_ENUM_NAME_Preview = 355,

        PDF_ENUM_NAME_Print = 356,

        PDF_ENUM_NAME_PrinterMark = 357,

        PDF_ENUM_NAME_ProcSet = 358,

        PDF_ENUM_NAME_Producer = 359,

        PDF_ENUM_NAME_Properties = 360,

        PDF_ENUM_NAME_Prop_AuthTime = 361,

        PDF_ENUM_NAME_Prop_AuthType = 362,

        PDF_ENUM_NAME_Prop_Build = 363,

        PDF_ENUM_NAME_PubSec = 364,

        PDF_ENUM_NAME_Push = 365,

        PDF_ENUM_NAME_Q = 366,

        PDF_ENUM_NAME_QuadPoints = 367,

        PDF_ENUM_NAME_R = 368,

        PDF_ENUM_NAME_RBGroups = 369,

        PDF_ENUM_NAME_RC = 370,

        PDF_ENUM_NAME_RClosedArrow = 371,

        PDF_ENUM_NAME_REx = 372,

        PDF_ENUM_NAME_RGB = 373,

        PDF_ENUM_NAME_RI = 374,

        PDF_ENUM_NAME_RL = 375,

        PDF_ENUM_NAME_ROpenArrow = 376,

        PDF_ENUM_NAME_Range = 377,

        PDF_ENUM_NAME_Reason = 378,

        PDF_ENUM_NAME_Rect = 379,

        PDF_ENUM_NAME_Redact = 380,

        PDF_ENUM_NAME_Ref = 381,

        PDF_ENUM_NAME_Reference = 382,

        PDF_ENUM_NAME_Registry = 383,

        PDF_ENUM_NAME_ResetForm = 384,

        PDF_ENUM_NAME_Resources = 385,

        PDF_ENUM_NAME_Root = 386,

        PDF_ENUM_NAME_Rotate = 387,

        PDF_ENUM_NAME_Rows = 388,

        PDF_ENUM_NAME_RunLengthDecode = 389,

        PDF_ENUM_NAME_S = 390,

        PDF_ENUM_NAME_SMask = 391,

        PDF_ENUM_NAME_SMaskInData = 392,

        PDF_ENUM_NAME_Schema = 393,

        PDF_ENUM_NAME_Screen = 394,

        PDF_ENUM_NAME_Separation = 395,

        PDF_ENUM_NAME_Shading = 396,

        PDF_ENUM_NAME_ShadingType = 397,

        PDF_ENUM_NAME_Si = 398,

        PDF_ENUM_NAME_Sig = 399,

        PDF_ENUM_NAME_SigFlags = 400,

        PDF_ENUM_NAME_SigQ = 401,

        PDF_ENUM_NAME_SigRef = 402,

        PDF_ENUM_NAME_Size = 403,

        PDF_ENUM_NAME_Slash = 404,

        PDF_ENUM_NAME_Sold = 405,

        PDF_ENUM_NAME_Sound = 406,

        PDF_ENUM_NAME_Split = 407,

        PDF_ENUM_NAME_Square = 408,

        PDF_ENUM_NAME_Squiggly = 409,

        PDF_ENUM_NAME_Stamp = 410,

        PDF_ENUM_NAME_Standard = 411,

        PDF_ENUM_NAME_StdCF = 412,

        PDF_ENUM_NAME_StemV = 413,

        PDF_ENUM_NAME_StmF = 414,

        PDF_ENUM_NAME_StrF = 415,

        PDF_ENUM_NAME_StrikeOut = 416,

        PDF_ENUM_NAME_StructParent = 417,

        PDF_ENUM_NAME_StructParents = 418,

        PDF_ENUM_NAME_SubFilter = 419,

        PDF_ENUM_NAME_Subtype = 420,

        PDF_ENUM_NAME_Subtype2 = 421,

        PDF_ENUM_NAME_Supplement = 422,

        PDF_ENUM_NAME_Symb = 423,

        PDF_ENUM_NAME_T = 424,

        PDF_ENUM_NAME_TI = 425,

        PDF_ENUM_NAME_TR = 426,

        PDF_ENUM_NAME_TR2 = 427,

        PDF_ENUM_NAME_TU = 428,

        PDF_ENUM_NAME_Text = 429,

        PDF_ENUM_NAME_TilingType = 430,

        PDF_ENUM_NAME_Times = 431,

        PDF_ENUM_NAME_Title = 432,

        PDF_ENUM_NAME_ToUnicode = 433,

        PDF_ENUM_NAME_TopSecret = 434,

        PDF_ENUM_NAME_Trans = 435,

        PDF_ENUM_NAME_TransformMethod = 436,

        PDF_ENUM_NAME_TransformParams = 437,

        PDF_ENUM_NAME_Transparency = 438,

        PDF_ENUM_NAME_TrapNet = 439,

        PDF_ENUM_NAME_TrimBox = 440,

        PDF_ENUM_NAME_TrueType = 441,

        PDF_ENUM_NAME_TrustedMode = 442,

        PDF_ENUM_NAME_Tx = 443,

        PDF_ENUM_NAME_Type = 444,

        PDF_ENUM_NAME_Type0 = 445,

        PDF_ENUM_NAME_Type1 = 446,

        PDF_ENUM_NAME_Type1C = 447,

        PDF_ENUM_NAME_Type3 = 448,

        PDF_ENUM_NAME_U = 449,

        PDF_ENUM_NAME_UE = 450,

        PDF_ENUM_NAME_UF = 451,

        PDF_ENUM_NAME_URI = 452,

        PDF_ENUM_NAME_URL = 453,

        PDF_ENUM_NAME_Unchanged = 454,

        PDF_ENUM_NAME_Uncover = 455,

        PDF_ENUM_NAME_Underline = 456,

        PDF_ENUM_NAME_Unix = 457,

        PDF_ENUM_NAME_Usage = 458,

        PDF_ENUM_NAME_UseBlackPtComp = 459,

        PDF_ENUM_NAME_UseCMap = 460,

        PDF_ENUM_NAME_UseOutlines = 461,

        PDF_ENUM_NAME_UserUnit = 462,

        PDF_ENUM_NAME_V = 463,

        PDF_ENUM_NAME_V2 = 464,

        PDF_ENUM_NAME_VE = 465,

        PDF_ENUM_NAME_Version = 466,

        PDF_ENUM_NAME_Vertices = 467,

        PDF_ENUM_NAME_VerticesPerRow = 468,

        PDF_ENUM_NAME_View = 469,

        PDF_ENUM_NAME_W = 470,

        PDF_ENUM_NAME_W2 = 471,

        PDF_ENUM_NAME_WMode = 472,

        PDF_ENUM_NAME_Watermark = 473,

        PDF_ENUM_NAME_WhitePoint = 474,

        PDF_ENUM_NAME_Widget = 475,

        PDF_ENUM_NAME_Width = 476,

        PDF_ENUM_NAME_Widths = 477,

        PDF_ENUM_NAME_WinAnsiEncoding = 478,

        PDF_ENUM_NAME_Wipe = 479,

        PDF_ENUM_NAME_XFA = 480,

        PDF_ENUM_NAME_XHeight = 481,

        PDF_ENUM_NAME_XML = 482,

        PDF_ENUM_NAME_XObject = 483,

        PDF_ENUM_NAME_XRef = 484,

        PDF_ENUM_NAME_XRefStm = 485,

        PDF_ENUM_NAME_XStep = 486,

        PDF_ENUM_NAME_XYZ = 487,

        PDF_ENUM_NAME_YStep = 488,

        PDF_ENUM_NAME_Yes = 489,

        PDF_ENUM_NAME_ZaDb = 490,

        PDF_ENUM_NAME_adbe_pkcs7_detached = 491,

        PDF_ENUM_NAME_ca = 492,

        PDF_ENUM_NAME_n0 = 493,

        PDF_ENUM_NAME_n1 = 494,

        PDF_ENUM_NAME_n2 = 495,

        PDF_ENUM_NAME_op = 496,

        PDF_ENUM_LIMIT = 497,
    }
    enum PDF_ENUM_NULL = _Anonymous_80.PDF_ENUM_NULL;
    enum PDF_ENUM_TRUE = _Anonymous_80.PDF_ENUM_TRUE;
    enum PDF_ENUM_FALSE = _Anonymous_80.PDF_ENUM_FALSE;
    enum PDF_ENUM_NAME_1_2 = _Anonymous_80.PDF_ENUM_NAME_1_2;
    enum PDF_ENUM_NAME_3D = _Anonymous_80.PDF_ENUM_NAME_3D;
    enum PDF_ENUM_NAME_A = _Anonymous_80.PDF_ENUM_NAME_A;
    enum PDF_ENUM_NAME_A85 = _Anonymous_80.PDF_ENUM_NAME_A85;
    enum PDF_ENUM_NAME_AA = _Anonymous_80.PDF_ENUM_NAME_AA;
    enum PDF_ENUM_NAME_AC = _Anonymous_80.PDF_ENUM_NAME_AC;
    enum PDF_ENUM_NAME_AESV2 = _Anonymous_80.PDF_ENUM_NAME_AESV2;
    enum PDF_ENUM_NAME_AESV3 = _Anonymous_80.PDF_ENUM_NAME_AESV3;
    enum PDF_ENUM_NAME_AHx = _Anonymous_80.PDF_ENUM_NAME_AHx;
    enum PDF_ENUM_NAME_AP = _Anonymous_80.PDF_ENUM_NAME_AP;
    enum PDF_ENUM_NAME_AS = _Anonymous_80.PDF_ENUM_NAME_AS;
    enum PDF_ENUM_NAME_ASCII85Decode = _Anonymous_80.PDF_ENUM_NAME_ASCII85Decode;
    enum PDF_ENUM_NAME_ASCIIHexDecode = _Anonymous_80.PDF_ENUM_NAME_ASCIIHexDecode;
    enum PDF_ENUM_NAME_AcroForm = _Anonymous_80.PDF_ENUM_NAME_AcroForm;
    enum PDF_ENUM_NAME_Action = _Anonymous_80.PDF_ENUM_NAME_Action;
    enum PDF_ENUM_NAME_ActualText = _Anonymous_80.PDF_ENUM_NAME_ActualText;
    enum PDF_ENUM_NAME_Adobe_PPKLite = _Anonymous_80.PDF_ENUM_NAME_Adobe_PPKLite;
    enum PDF_ENUM_NAME_All = _Anonymous_80.PDF_ENUM_NAME_All;
    enum PDF_ENUM_NAME_AllOff = _Anonymous_80.PDF_ENUM_NAME_AllOff;
    enum PDF_ENUM_NAME_AllOn = _Anonymous_80.PDF_ENUM_NAME_AllOn;
    enum PDF_ENUM_NAME_Alpha = _Anonymous_80.PDF_ENUM_NAME_Alpha;
    enum PDF_ENUM_NAME_Alt = _Anonymous_80.PDF_ENUM_NAME_Alt;
    enum PDF_ENUM_NAME_Alternate = _Anonymous_80.PDF_ENUM_NAME_Alternate;
    enum PDF_ENUM_NAME_Annot = _Anonymous_80.PDF_ENUM_NAME_Annot;
    enum PDF_ENUM_NAME_Annots = _Anonymous_80.PDF_ENUM_NAME_Annots;
    enum PDF_ENUM_NAME_AnyOff = _Anonymous_80.PDF_ENUM_NAME_AnyOff;
    enum PDF_ENUM_NAME_App = _Anonymous_80.PDF_ENUM_NAME_App;
    enum PDF_ENUM_NAME_Approved = _Anonymous_80.PDF_ENUM_NAME_Approved;
    enum PDF_ENUM_NAME_ArtBox = _Anonymous_80.PDF_ENUM_NAME_ArtBox;
    enum PDF_ENUM_NAME_AsIs = _Anonymous_80.PDF_ENUM_NAME_AsIs;
    enum PDF_ENUM_NAME_Ascent = _Anonymous_80.PDF_ENUM_NAME_Ascent;
    enum PDF_ENUM_NAME_AuthEvent = _Anonymous_80.PDF_ENUM_NAME_AuthEvent;
    enum PDF_ENUM_NAME_B = _Anonymous_80.PDF_ENUM_NAME_B;
    enum PDF_ENUM_NAME_BBox = _Anonymous_80.PDF_ENUM_NAME_BBox;
    enum PDF_ENUM_NAME_BC = _Anonymous_80.PDF_ENUM_NAME_BC;
    enum PDF_ENUM_NAME_BE = _Anonymous_80.PDF_ENUM_NAME_BE;
    enum PDF_ENUM_NAME_BG = _Anonymous_80.PDF_ENUM_NAME_BG;
    enum PDF_ENUM_NAME_BM = _Anonymous_80.PDF_ENUM_NAME_BM;
    enum PDF_ENUM_NAME_BPC = _Anonymous_80.PDF_ENUM_NAME_BPC;
    enum PDF_ENUM_NAME_BS = _Anonymous_80.PDF_ENUM_NAME_BS;
    enum PDF_ENUM_NAME_Background = _Anonymous_80.PDF_ENUM_NAME_Background;
    enum PDF_ENUM_NAME_BaseEncoding = _Anonymous_80.PDF_ENUM_NAME_BaseEncoding;
    enum PDF_ENUM_NAME_BaseFont = _Anonymous_80.PDF_ENUM_NAME_BaseFont;
    enum PDF_ENUM_NAME_BaseState = _Anonymous_80.PDF_ENUM_NAME_BaseState;
    enum PDF_ENUM_NAME_BitsPerComponent = _Anonymous_80.PDF_ENUM_NAME_BitsPerComponent;
    enum PDF_ENUM_NAME_BitsPerCoordinate = _Anonymous_80.PDF_ENUM_NAME_BitsPerCoordinate;
    enum PDF_ENUM_NAME_BitsPerFlag = _Anonymous_80.PDF_ENUM_NAME_BitsPerFlag;
    enum PDF_ENUM_NAME_BitsPerSample = _Anonymous_80.PDF_ENUM_NAME_BitsPerSample;
    enum PDF_ENUM_NAME_BlackIs1 = _Anonymous_80.PDF_ENUM_NAME_BlackIs1;
    enum PDF_ENUM_NAME_BlackPoint = _Anonymous_80.PDF_ENUM_NAME_BlackPoint;
    enum PDF_ENUM_NAME_BleedBox = _Anonymous_80.PDF_ENUM_NAME_BleedBox;
    enum PDF_ENUM_NAME_Blinds = _Anonymous_80.PDF_ENUM_NAME_Blinds;
    enum PDF_ENUM_NAME_Border = _Anonymous_80.PDF_ENUM_NAME_Border;
    enum PDF_ENUM_NAME_Bounds = _Anonymous_80.PDF_ENUM_NAME_Bounds;
    enum PDF_ENUM_NAME_Box = _Anonymous_80.PDF_ENUM_NAME_Box;
    enum PDF_ENUM_NAME_Bt = _Anonymous_80.PDF_ENUM_NAME_Bt;
    enum PDF_ENUM_NAME_Btn = _Anonymous_80.PDF_ENUM_NAME_Btn;
    enum PDF_ENUM_NAME_Butt = _Anonymous_80.PDF_ENUM_NAME_Butt;
    enum PDF_ENUM_NAME_ByteRange = _Anonymous_80.PDF_ENUM_NAME_ByteRange;
    enum PDF_ENUM_NAME_C = _Anonymous_80.PDF_ENUM_NAME_C;
    enum PDF_ENUM_NAME_C0 = _Anonymous_80.PDF_ENUM_NAME_C0;
    enum PDF_ENUM_NAME_C1 = _Anonymous_80.PDF_ENUM_NAME_C1;
    enum PDF_ENUM_NAME_CA = _Anonymous_80.PDF_ENUM_NAME_CA;
    enum PDF_ENUM_NAME_CCF = _Anonymous_80.PDF_ENUM_NAME_CCF;
    enum PDF_ENUM_NAME_CCITTFaxDecode = _Anonymous_80.PDF_ENUM_NAME_CCITTFaxDecode;
    enum PDF_ENUM_NAME_CF = _Anonymous_80.PDF_ENUM_NAME_CF;
    enum PDF_ENUM_NAME_CFM = _Anonymous_80.PDF_ENUM_NAME_CFM;
    enum PDF_ENUM_NAME_CI = _Anonymous_80.PDF_ENUM_NAME_CI;
    enum PDF_ENUM_NAME_CIDFontType0 = _Anonymous_80.PDF_ENUM_NAME_CIDFontType0;
    enum PDF_ENUM_NAME_CIDFontType0C = _Anonymous_80.PDF_ENUM_NAME_CIDFontType0C;
    enum PDF_ENUM_NAME_CIDFontType2 = _Anonymous_80.PDF_ENUM_NAME_CIDFontType2;
    enum PDF_ENUM_NAME_CIDSystemInfo = _Anonymous_80.PDF_ENUM_NAME_CIDSystemInfo;
    enum PDF_ENUM_NAME_CIDToGIDMap = _Anonymous_80.PDF_ENUM_NAME_CIDToGIDMap;
    enum PDF_ENUM_NAME_CMYK = _Anonymous_80.PDF_ENUM_NAME_CMYK;
    enum PDF_ENUM_NAME_CS = _Anonymous_80.PDF_ENUM_NAME_CS;
    enum PDF_ENUM_NAME_CalCMYK = _Anonymous_80.PDF_ENUM_NAME_CalCMYK;
    enum PDF_ENUM_NAME_CalGray = _Anonymous_80.PDF_ENUM_NAME_CalGray;
    enum PDF_ENUM_NAME_CalRGB = _Anonymous_80.PDF_ENUM_NAME_CalRGB;
    enum PDF_ENUM_NAME_CapHeight = _Anonymous_80.PDF_ENUM_NAME_CapHeight;
    enum PDF_ENUM_NAME_Caret = _Anonymous_80.PDF_ENUM_NAME_Caret;
    enum PDF_ENUM_NAME_Catalog = _Anonymous_80.PDF_ENUM_NAME_Catalog;
    enum PDF_ENUM_NAME_Cert = _Anonymous_80.PDF_ENUM_NAME_Cert;
    enum PDF_ENUM_NAME_Ch = _Anonymous_80.PDF_ENUM_NAME_Ch;
    enum PDF_ENUM_NAME_Changes = _Anonymous_80.PDF_ENUM_NAME_Changes;
    enum PDF_ENUM_NAME_CharProcs = _Anonymous_80.PDF_ENUM_NAME_CharProcs;
    enum PDF_ENUM_NAME_Circle = _Anonymous_80.PDF_ENUM_NAME_Circle;
    enum PDF_ENUM_NAME_ClosedArrow = _Anonymous_80.PDF_ENUM_NAME_ClosedArrow;
    enum PDF_ENUM_NAME_Collection = _Anonymous_80.PDF_ENUM_NAME_Collection;
    enum PDF_ENUM_NAME_ColorSpace = _Anonymous_80.PDF_ENUM_NAME_ColorSpace;
    enum PDF_ENUM_NAME_ColorTransform = _Anonymous_80.PDF_ENUM_NAME_ColorTransform;
    enum PDF_ENUM_NAME_Colorants = _Anonymous_80.PDF_ENUM_NAME_Colorants;
    enum PDF_ENUM_NAME_Colors = _Anonymous_80.PDF_ENUM_NAME_Colors;
    enum PDF_ENUM_NAME_Columns = _Anonymous_80.PDF_ENUM_NAME_Columns;
    enum PDF_ENUM_NAME_Confidential = _Anonymous_80.PDF_ENUM_NAME_Confidential;
    enum PDF_ENUM_NAME_Configs = _Anonymous_80.PDF_ENUM_NAME_Configs;
    enum PDF_ENUM_NAME_ContactInfo = _Anonymous_80.PDF_ENUM_NAME_ContactInfo;
    enum PDF_ENUM_NAME_Contents = _Anonymous_80.PDF_ENUM_NAME_Contents;
    enum PDF_ENUM_NAME_Coords = _Anonymous_80.PDF_ENUM_NAME_Coords;
    enum PDF_ENUM_NAME_Count = _Anonymous_80.PDF_ENUM_NAME_Count;
    enum PDF_ENUM_NAME_Cover = _Anonymous_80.PDF_ENUM_NAME_Cover;
    enum PDF_ENUM_NAME_CreationDate = _Anonymous_80.PDF_ENUM_NAME_CreationDate;
    enum PDF_ENUM_NAME_Creator = _Anonymous_80.PDF_ENUM_NAME_Creator;
    enum PDF_ENUM_NAME_CropBox = _Anonymous_80.PDF_ENUM_NAME_CropBox;
    enum PDF_ENUM_NAME_Crypt = _Anonymous_80.PDF_ENUM_NAME_Crypt;
    enum PDF_ENUM_NAME_D = _Anonymous_80.PDF_ENUM_NAME_D;
    enum PDF_ENUM_NAME_DA = _Anonymous_80.PDF_ENUM_NAME_DA;
    enum PDF_ENUM_NAME_DC = _Anonymous_80.PDF_ENUM_NAME_DC;
    enum PDF_ENUM_NAME_DCT = _Anonymous_80.PDF_ENUM_NAME_DCT;
    enum PDF_ENUM_NAME_DCTDecode = _Anonymous_80.PDF_ENUM_NAME_DCTDecode;
    enum PDF_ENUM_NAME_DL = _Anonymous_80.PDF_ENUM_NAME_DL;
    enum PDF_ENUM_NAME_DOS = _Anonymous_80.PDF_ENUM_NAME_DOS;
    enum PDF_ENUM_NAME_DP = _Anonymous_80.PDF_ENUM_NAME_DP;
    enum PDF_ENUM_NAME_DR = _Anonymous_80.PDF_ENUM_NAME_DR;
    enum PDF_ENUM_NAME_DS = _Anonymous_80.PDF_ENUM_NAME_DS;
    enum PDF_ENUM_NAME_DV = _Anonymous_80.PDF_ENUM_NAME_DV;
    enum PDF_ENUM_NAME_DW = _Anonymous_80.PDF_ENUM_NAME_DW;
    enum PDF_ENUM_NAME_DW2 = _Anonymous_80.PDF_ENUM_NAME_DW2;
    enum PDF_ENUM_NAME_DamagedRowsBeforeError = _Anonymous_80.PDF_ENUM_NAME_DamagedRowsBeforeError;
    enum PDF_ENUM_NAME_Data = _Anonymous_80.PDF_ENUM_NAME_Data;
    enum PDF_ENUM_NAME_Date = _Anonymous_80.PDF_ENUM_NAME_Date;
    enum PDF_ENUM_NAME_Decode = _Anonymous_80.PDF_ENUM_NAME_Decode;
    enum PDF_ENUM_NAME_DecodeParms = _Anonymous_80.PDF_ENUM_NAME_DecodeParms;
    enum PDF_ENUM_NAME_Default = _Anonymous_80.PDF_ENUM_NAME_Default;
    enum PDF_ENUM_NAME_DefaultCMYK = _Anonymous_80.PDF_ENUM_NAME_DefaultCMYK;
    enum PDF_ENUM_NAME_DefaultGray = _Anonymous_80.PDF_ENUM_NAME_DefaultGray;
    enum PDF_ENUM_NAME_DefaultRGB = _Anonymous_80.PDF_ENUM_NAME_DefaultRGB;
    enum PDF_ENUM_NAME_Departmental = _Anonymous_80.PDF_ENUM_NAME_Departmental;
    enum PDF_ENUM_NAME_Desc = _Anonymous_80.PDF_ENUM_NAME_Desc;
    enum PDF_ENUM_NAME_DescendantFonts = _Anonymous_80.PDF_ENUM_NAME_DescendantFonts;
    enum PDF_ENUM_NAME_Descent = _Anonymous_80.PDF_ENUM_NAME_Descent;
    enum PDF_ENUM_NAME_Design = _Anonymous_80.PDF_ENUM_NAME_Design;
    enum PDF_ENUM_NAME_Dest = _Anonymous_80.PDF_ENUM_NAME_Dest;
    enum PDF_ENUM_NAME_DestOutputProfile = _Anonymous_80.PDF_ENUM_NAME_DestOutputProfile;
    enum PDF_ENUM_NAME_Dests = _Anonymous_80.PDF_ENUM_NAME_Dests;
    enum PDF_ENUM_NAME_DeviceCMYK = _Anonymous_80.PDF_ENUM_NAME_DeviceCMYK;
    enum PDF_ENUM_NAME_DeviceGray = _Anonymous_80.PDF_ENUM_NAME_DeviceGray;
    enum PDF_ENUM_NAME_DeviceN = _Anonymous_80.PDF_ENUM_NAME_DeviceN;
    enum PDF_ENUM_NAME_DeviceRGB = _Anonymous_80.PDF_ENUM_NAME_DeviceRGB;
    enum PDF_ENUM_NAME_Di = _Anonymous_80.PDF_ENUM_NAME_Di;
    enum PDF_ENUM_NAME_Diamond = _Anonymous_80.PDF_ENUM_NAME_Diamond;
    enum PDF_ENUM_NAME_Differences = _Anonymous_80.PDF_ENUM_NAME_Differences;
    enum PDF_ENUM_NAME_DigestLocation = _Anonymous_80.PDF_ENUM_NAME_DigestLocation;
    enum PDF_ENUM_NAME_DigestMethod = _Anonymous_80.PDF_ENUM_NAME_DigestMethod;
    enum PDF_ENUM_NAME_DigestValue = _Anonymous_80.PDF_ENUM_NAME_DigestValue;
    enum PDF_ENUM_NAME_Dissolve = _Anonymous_80.PDF_ENUM_NAME_Dissolve;
    enum PDF_ENUM_NAME_Dm = _Anonymous_80.PDF_ENUM_NAME_Dm;
    enum PDF_ENUM_NAME_DocMDP = _Anonymous_80.PDF_ENUM_NAME_DocMDP;
    enum PDF_ENUM_NAME_Document = _Anonymous_80.PDF_ENUM_NAME_Document;
    enum PDF_ENUM_NAME_Domain = _Anonymous_80.PDF_ENUM_NAME_Domain;
    enum PDF_ENUM_NAME_Draft = _Anonymous_80.PDF_ENUM_NAME_Draft;
    enum PDF_ENUM_NAME_Dur = _Anonymous_80.PDF_ENUM_NAME_Dur;
    enum PDF_ENUM_NAME_E = _Anonymous_80.PDF_ENUM_NAME_E;
    enum PDF_ENUM_NAME_EF = _Anonymous_80.PDF_ENUM_NAME_EF;
    enum PDF_ENUM_NAME_EarlyChange = _Anonymous_80.PDF_ENUM_NAME_EarlyChange;
    enum PDF_ENUM_NAME_EmbeddedFile = _Anonymous_80.PDF_ENUM_NAME_EmbeddedFile;
    enum PDF_ENUM_NAME_EmbeddedFiles = _Anonymous_80.PDF_ENUM_NAME_EmbeddedFiles;
    enum PDF_ENUM_NAME_Encode = _Anonymous_80.PDF_ENUM_NAME_Encode;
    enum PDF_ENUM_NAME_EncodedByteAlign = _Anonymous_80.PDF_ENUM_NAME_EncodedByteAlign;
    enum PDF_ENUM_NAME_Encoding = _Anonymous_80.PDF_ENUM_NAME_Encoding;
    enum PDF_ENUM_NAME_Encrypt = _Anonymous_80.PDF_ENUM_NAME_Encrypt;
    enum PDF_ENUM_NAME_EncryptMetadata = _Anonymous_80.PDF_ENUM_NAME_EncryptMetadata;
    enum PDF_ENUM_NAME_EndOfBlock = _Anonymous_80.PDF_ENUM_NAME_EndOfBlock;
    enum PDF_ENUM_NAME_EndOfLine = _Anonymous_80.PDF_ENUM_NAME_EndOfLine;
    enum PDF_ENUM_NAME_Exclude = _Anonymous_80.PDF_ENUM_NAME_Exclude;
    enum PDF_ENUM_NAME_Experimental = _Anonymous_80.PDF_ENUM_NAME_Experimental;
    enum PDF_ENUM_NAME_Expired = _Anonymous_80.PDF_ENUM_NAME_Expired;
    enum PDF_ENUM_NAME_ExtGState = _Anonymous_80.PDF_ENUM_NAME_ExtGState;
    enum PDF_ENUM_NAME_Extend = _Anonymous_80.PDF_ENUM_NAME_Extend;
    enum PDF_ENUM_NAME_F = _Anonymous_80.PDF_ENUM_NAME_F;
    enum PDF_ENUM_NAME_FL = _Anonymous_80.PDF_ENUM_NAME_FL;
    enum PDF_ENUM_NAME_FRM = _Anonymous_80.PDF_ENUM_NAME_FRM;
    enum PDF_ENUM_NAME_FS = _Anonymous_80.PDF_ENUM_NAME_FS;
    enum PDF_ENUM_NAME_FT = _Anonymous_80.PDF_ENUM_NAME_FT;
    enum PDF_ENUM_NAME_Fade = _Anonymous_80.PDF_ENUM_NAME_Fade;
    enum PDF_ENUM_NAME_Ff = _Anonymous_80.PDF_ENUM_NAME_Ff;
    enum PDF_ENUM_NAME_FieldMDP = _Anonymous_80.PDF_ENUM_NAME_FieldMDP;
    enum PDF_ENUM_NAME_Fields = _Anonymous_80.PDF_ENUM_NAME_Fields;
    enum PDF_ENUM_NAME_FileAttachment = _Anonymous_80.PDF_ENUM_NAME_FileAttachment;
    enum PDF_ENUM_NAME_FileSize = _Anonymous_80.PDF_ENUM_NAME_FileSize;
    enum PDF_ENUM_NAME_Filespec = _Anonymous_80.PDF_ENUM_NAME_Filespec;
    enum PDF_ENUM_NAME_Filter = _Anonymous_80.PDF_ENUM_NAME_Filter;
    enum PDF_ENUM_NAME_Final = _Anonymous_80.PDF_ENUM_NAME_Final;
    enum PDF_ENUM_NAME_Fingerprint = _Anonymous_80.PDF_ENUM_NAME_Fingerprint;
    enum PDF_ENUM_NAME_First = _Anonymous_80.PDF_ENUM_NAME_First;
    enum PDF_ENUM_NAME_FirstChar = _Anonymous_80.PDF_ENUM_NAME_FirstChar;
    enum PDF_ENUM_NAME_FirstPage = _Anonymous_80.PDF_ENUM_NAME_FirstPage;
    enum PDF_ENUM_NAME_Fit = _Anonymous_80.PDF_ENUM_NAME_Fit;
    enum PDF_ENUM_NAME_FitB = _Anonymous_80.PDF_ENUM_NAME_FitB;
    enum PDF_ENUM_NAME_FitBH = _Anonymous_80.PDF_ENUM_NAME_FitBH;
    enum PDF_ENUM_NAME_FitBV = _Anonymous_80.PDF_ENUM_NAME_FitBV;
    enum PDF_ENUM_NAME_FitH = _Anonymous_80.PDF_ENUM_NAME_FitH;
    enum PDF_ENUM_NAME_FitR = _Anonymous_80.PDF_ENUM_NAME_FitR;
    enum PDF_ENUM_NAME_FitV = _Anonymous_80.PDF_ENUM_NAME_FitV;
    enum PDF_ENUM_NAME_Fl = _Anonymous_80.PDF_ENUM_NAME_Fl;
    enum PDF_ENUM_NAME_Flags = _Anonymous_80.PDF_ENUM_NAME_Flags;
    enum PDF_ENUM_NAME_FlateDecode = _Anonymous_80.PDF_ENUM_NAME_FlateDecode;
    enum PDF_ENUM_NAME_Fly = _Anonymous_80.PDF_ENUM_NAME_Fly;
    enum PDF_ENUM_NAME_Font = _Anonymous_80.PDF_ENUM_NAME_Font;
    enum PDF_ENUM_NAME_FontBBox = _Anonymous_80.PDF_ENUM_NAME_FontBBox;
    enum PDF_ENUM_NAME_FontDescriptor = _Anonymous_80.PDF_ENUM_NAME_FontDescriptor;
    enum PDF_ENUM_NAME_FontFile = _Anonymous_80.PDF_ENUM_NAME_FontFile;
    enum PDF_ENUM_NAME_FontFile2 = _Anonymous_80.PDF_ENUM_NAME_FontFile2;
    enum PDF_ENUM_NAME_FontFile3 = _Anonymous_80.PDF_ENUM_NAME_FontFile3;
    enum PDF_ENUM_NAME_FontMatrix = _Anonymous_80.PDF_ENUM_NAME_FontMatrix;
    enum PDF_ENUM_NAME_FontName = _Anonymous_80.PDF_ENUM_NAME_FontName;
    enum PDF_ENUM_NAME_ForComment = _Anonymous_80.PDF_ENUM_NAME_ForComment;
    enum PDF_ENUM_NAME_ForPublicRelease = _Anonymous_80.PDF_ENUM_NAME_ForPublicRelease;
    enum PDF_ENUM_NAME_Form = _Anonymous_80.PDF_ENUM_NAME_Form;
    enum PDF_ENUM_NAME_FormEx = _Anonymous_80.PDF_ENUM_NAME_FormEx;
    enum PDF_ENUM_NAME_FormType = _Anonymous_80.PDF_ENUM_NAME_FormType;
    enum PDF_ENUM_NAME_FreeText = _Anonymous_80.PDF_ENUM_NAME_FreeText;
    enum PDF_ENUM_NAME_Function = _Anonymous_80.PDF_ENUM_NAME_Function;
    enum PDF_ENUM_NAME_FunctionType = _Anonymous_80.PDF_ENUM_NAME_FunctionType;
    enum PDF_ENUM_NAME_Functions = _Anonymous_80.PDF_ENUM_NAME_Functions;
    enum PDF_ENUM_NAME_G = _Anonymous_80.PDF_ENUM_NAME_G;
    enum PDF_ENUM_NAME_Gamma = _Anonymous_80.PDF_ENUM_NAME_Gamma;
    enum PDF_ENUM_NAME_Glitter = _Anonymous_80.PDF_ENUM_NAME_Glitter;
    enum PDF_ENUM_NAME_GoTo = _Anonymous_80.PDF_ENUM_NAME_GoTo;
    enum PDF_ENUM_NAME_GoToR = _Anonymous_80.PDF_ENUM_NAME_GoToR;
    enum PDF_ENUM_NAME_Group = _Anonymous_80.PDF_ENUM_NAME_Group;
    enum PDF_ENUM_NAME_H = _Anonymous_80.PDF_ENUM_NAME_H;
    enum PDF_ENUM_NAME_Height = _Anonymous_80.PDF_ENUM_NAME_Height;
    enum PDF_ENUM_NAME_Helv = _Anonymous_80.PDF_ENUM_NAME_Helv;
    enum PDF_ENUM_NAME_Highlight = _Anonymous_80.PDF_ENUM_NAME_Highlight;
    enum PDF_ENUM_NAME_HistoryPos = _Anonymous_80.PDF_ENUM_NAME_HistoryPos;
    enum PDF_ENUM_NAME_I = _Anonymous_80.PDF_ENUM_NAME_I;
    enum PDF_ENUM_NAME_IC = _Anonymous_80.PDF_ENUM_NAME_IC;
    enum PDF_ENUM_NAME_ICCBased = _Anonymous_80.PDF_ENUM_NAME_ICCBased;
    enum PDF_ENUM_NAME_ID = _Anonymous_80.PDF_ENUM_NAME_ID;
    enum PDF_ENUM_NAME_IM = _Anonymous_80.PDF_ENUM_NAME_IM;
    enum PDF_ENUM_NAME_IRT = _Anonymous_80.PDF_ENUM_NAME_IRT;
    enum PDF_ENUM_NAME_Identity = _Anonymous_80.PDF_ENUM_NAME_Identity;
    enum PDF_ENUM_NAME_Identity_H = _Anonymous_80.PDF_ENUM_NAME_Identity_H;
    enum PDF_ENUM_NAME_Identity_V = _Anonymous_80.PDF_ENUM_NAME_Identity_V;
    enum PDF_ENUM_NAME_Image = _Anonymous_80.PDF_ENUM_NAME_Image;
    enum PDF_ENUM_NAME_ImageMask = _Anonymous_80.PDF_ENUM_NAME_ImageMask;
    enum PDF_ENUM_NAME_Include = _Anonymous_80.PDF_ENUM_NAME_Include;
    enum PDF_ENUM_NAME_Index = _Anonymous_80.PDF_ENUM_NAME_Index;
    enum PDF_ENUM_NAME_Indexed = _Anonymous_80.PDF_ENUM_NAME_Indexed;
    enum PDF_ENUM_NAME_Info = _Anonymous_80.PDF_ENUM_NAME_Info;
    enum PDF_ENUM_NAME_Ink = _Anonymous_80.PDF_ENUM_NAME_Ink;
    enum PDF_ENUM_NAME_InkList = _Anonymous_80.PDF_ENUM_NAME_InkList;
    enum PDF_ENUM_NAME_Intent = _Anonymous_80.PDF_ENUM_NAME_Intent;
    enum PDF_ENUM_NAME_Interpolate = _Anonymous_80.PDF_ENUM_NAME_Interpolate;
    enum PDF_ENUM_NAME_IsMap = _Anonymous_80.PDF_ENUM_NAME_IsMap;
    enum PDF_ENUM_NAME_ItalicAngle = _Anonymous_80.PDF_ENUM_NAME_ItalicAngle;
    enum PDF_ENUM_NAME_JBIG2Decode = _Anonymous_80.PDF_ENUM_NAME_JBIG2Decode;
    enum PDF_ENUM_NAME_JBIG2Globals = _Anonymous_80.PDF_ENUM_NAME_JBIG2Globals;
    enum PDF_ENUM_NAME_JPXDecode = _Anonymous_80.PDF_ENUM_NAME_JPXDecode;
    enum PDF_ENUM_NAME_JS = _Anonymous_80.PDF_ENUM_NAME_JS;
    enum PDF_ENUM_NAME_JavaScript = _Anonymous_80.PDF_ENUM_NAME_JavaScript;
    enum PDF_ENUM_NAME_K = _Anonymous_80.PDF_ENUM_NAME_K;
    enum PDF_ENUM_NAME_Kids = _Anonymous_80.PDF_ENUM_NAME_Kids;
    enum PDF_ENUM_NAME_L = _Anonymous_80.PDF_ENUM_NAME_L;
    enum PDF_ENUM_NAME_LC = _Anonymous_80.PDF_ENUM_NAME_LC;
    enum PDF_ENUM_NAME_LE = _Anonymous_80.PDF_ENUM_NAME_LE;
    enum PDF_ENUM_NAME_LJ = _Anonymous_80.PDF_ENUM_NAME_LJ;
    enum PDF_ENUM_NAME_LW = _Anonymous_80.PDF_ENUM_NAME_LW;
    enum PDF_ENUM_NAME_LZ = _Anonymous_80.PDF_ENUM_NAME_LZ;
    enum PDF_ENUM_NAME_LZW = _Anonymous_80.PDF_ENUM_NAME_LZW;
    enum PDF_ENUM_NAME_LZWDecode = _Anonymous_80.PDF_ENUM_NAME_LZWDecode;
    enum PDF_ENUM_NAME_Lab = _Anonymous_80.PDF_ENUM_NAME_Lab;
    enum PDF_ENUM_NAME_Lang = _Anonymous_80.PDF_ENUM_NAME_Lang;
    enum PDF_ENUM_NAME_Last = _Anonymous_80.PDF_ENUM_NAME_Last;
    enum PDF_ENUM_NAME_LastChar = _Anonymous_80.PDF_ENUM_NAME_LastChar;
    enum PDF_ENUM_NAME_LastPage = _Anonymous_80.PDF_ENUM_NAME_LastPage;
    enum PDF_ENUM_NAME_Launch = _Anonymous_80.PDF_ENUM_NAME_Launch;
    enum PDF_ENUM_NAME_Length = _Anonymous_80.PDF_ENUM_NAME_Length;
    enum PDF_ENUM_NAME_Length1 = _Anonymous_80.PDF_ENUM_NAME_Length1;
    enum PDF_ENUM_NAME_Length2 = _Anonymous_80.PDF_ENUM_NAME_Length2;
    enum PDF_ENUM_NAME_Length3 = _Anonymous_80.PDF_ENUM_NAME_Length3;
    enum PDF_ENUM_NAME_Limits = _Anonymous_80.PDF_ENUM_NAME_Limits;
    enum PDF_ENUM_NAME_Line = _Anonymous_80.PDF_ENUM_NAME_Line;
    enum PDF_ENUM_NAME_Linearized = _Anonymous_80.PDF_ENUM_NAME_Linearized;
    enum PDF_ENUM_NAME_Link = _Anonymous_80.PDF_ENUM_NAME_Link;
    enum PDF_ENUM_NAME_Location = _Anonymous_80.PDF_ENUM_NAME_Location;
    enum PDF_ENUM_NAME_Lock = _Anonymous_80.PDF_ENUM_NAME_Lock;
    enum PDF_ENUM_NAME_Locked = _Anonymous_80.PDF_ENUM_NAME_Locked;
    enum PDF_ENUM_NAME_Luminosity = _Anonymous_80.PDF_ENUM_NAME_Luminosity;
    enum PDF_ENUM_NAME_M = _Anonymous_80.PDF_ENUM_NAME_M;
    enum PDF_ENUM_NAME_MCID = _Anonymous_80.PDF_ENUM_NAME_MCID;
    enum PDF_ENUM_NAME_MK = _Anonymous_80.PDF_ENUM_NAME_MK;
    enum PDF_ENUM_NAME_ML = _Anonymous_80.PDF_ENUM_NAME_ML;
    enum PDF_ENUM_NAME_MMType1 = _Anonymous_80.PDF_ENUM_NAME_MMType1;
    enum PDF_ENUM_NAME_Mac = _Anonymous_80.PDF_ENUM_NAME_Mac;
    enum PDF_ENUM_NAME_Mask = _Anonymous_80.PDF_ENUM_NAME_Mask;
    enum PDF_ENUM_NAME_Matrix = _Anonymous_80.PDF_ENUM_NAME_Matrix;
    enum PDF_ENUM_NAME_Matte = _Anonymous_80.PDF_ENUM_NAME_Matte;
    enum PDF_ENUM_NAME_MaxLen = _Anonymous_80.PDF_ENUM_NAME_MaxLen;
    enum PDF_ENUM_NAME_MediaBox = _Anonymous_80.PDF_ENUM_NAME_MediaBox;
    enum PDF_ENUM_NAME_Metadata = _Anonymous_80.PDF_ENUM_NAME_Metadata;
    enum PDF_ENUM_NAME_MissingWidth = _Anonymous_80.PDF_ENUM_NAME_MissingWidth;
    enum PDF_ENUM_NAME_ModDate = _Anonymous_80.PDF_ENUM_NAME_ModDate;
    enum PDF_ENUM_NAME_Movie = _Anonymous_80.PDF_ENUM_NAME_Movie;
    enum PDF_ENUM_NAME_Msg = _Anonymous_80.PDF_ENUM_NAME_Msg;
    enum PDF_ENUM_NAME_Multiply = _Anonymous_80.PDF_ENUM_NAME_Multiply;
    enum PDF_ENUM_NAME_N = _Anonymous_80.PDF_ENUM_NAME_N;
    enum PDF_ENUM_NAME_Name = _Anonymous_80.PDF_ENUM_NAME_Name;
    enum PDF_ENUM_NAME_Named = _Anonymous_80.PDF_ENUM_NAME_Named;
    enum PDF_ENUM_NAME_Names = _Anonymous_80.PDF_ENUM_NAME_Names;
    enum PDF_ENUM_NAME_NewWindow = _Anonymous_80.PDF_ENUM_NAME_NewWindow;
    enum PDF_ENUM_NAME_Next = _Anonymous_80.PDF_ENUM_NAME_Next;
    enum PDF_ENUM_NAME_NextPage = _Anonymous_80.PDF_ENUM_NAME_NextPage;
    enum PDF_ENUM_NAME_NonEFontNoWarn = _Anonymous_80.PDF_ENUM_NAME_NonEFontNoWarn;
    enum PDF_ENUM_NAME_None = _Anonymous_80.PDF_ENUM_NAME_None;
    enum PDF_ENUM_NAME_Normal = _Anonymous_80.PDF_ENUM_NAME_Normal;
    enum PDF_ENUM_NAME_NotApproved = _Anonymous_80.PDF_ENUM_NAME_NotApproved;
    enum PDF_ENUM_NAME_NotForPublicRelease = _Anonymous_80.PDF_ENUM_NAME_NotForPublicRelease;
    enum PDF_ENUM_NAME_NumSections = _Anonymous_80.PDF_ENUM_NAME_NumSections;
    enum PDF_ENUM_NAME_Nums = _Anonymous_80.PDF_ENUM_NAME_Nums;
    enum PDF_ENUM_NAME_O = _Anonymous_80.PDF_ENUM_NAME_O;
    enum PDF_ENUM_NAME_OC = _Anonymous_80.PDF_ENUM_NAME_OC;
    enum PDF_ENUM_NAME_OCG = _Anonymous_80.PDF_ENUM_NAME_OCG;
    enum PDF_ENUM_NAME_OCGs = _Anonymous_80.PDF_ENUM_NAME_OCGs;
    enum PDF_ENUM_NAME_OCMD = _Anonymous_80.PDF_ENUM_NAME_OCMD;
    enum PDF_ENUM_NAME_OCProperties = _Anonymous_80.PDF_ENUM_NAME_OCProperties;
    enum PDF_ENUM_NAME_OE = _Anonymous_80.PDF_ENUM_NAME_OE;
    enum PDF_ENUM_NAME_OFF = _Anonymous_80.PDF_ENUM_NAME_OFF;
    enum PDF_ENUM_NAME_ON = _Anonymous_80.PDF_ENUM_NAME_ON;
    enum PDF_ENUM_NAME_OP = _Anonymous_80.PDF_ENUM_NAME_OP;
    enum PDF_ENUM_NAME_OPM = _Anonymous_80.PDF_ENUM_NAME_OPM;
    enum PDF_ENUM_NAME_OS = _Anonymous_80.PDF_ENUM_NAME_OS;
    enum PDF_ENUM_NAME_ObjStm = _Anonymous_80.PDF_ENUM_NAME_ObjStm;
    enum PDF_ENUM_NAME_Of = _Anonymous_80.PDF_ENUM_NAME_Of;
    enum PDF_ENUM_NAME_Off = _Anonymous_80.PDF_ENUM_NAME_Off;
    enum PDF_ENUM_NAME_Open = _Anonymous_80.PDF_ENUM_NAME_Open;
    enum PDF_ENUM_NAME_OpenArrow = _Anonymous_80.PDF_ENUM_NAME_OpenArrow;
    enum PDF_ENUM_NAME_OpenType = _Anonymous_80.PDF_ENUM_NAME_OpenType;
    enum PDF_ENUM_NAME_Opt = _Anonymous_80.PDF_ENUM_NAME_Opt;
    enum PDF_ENUM_NAME_Order = _Anonymous_80.PDF_ENUM_NAME_Order;
    enum PDF_ENUM_NAME_Ordering = _Anonymous_80.PDF_ENUM_NAME_Ordering;
    enum PDF_ENUM_NAME_Outlines = _Anonymous_80.PDF_ENUM_NAME_Outlines;
    enum PDF_ENUM_NAME_OutputIntents = _Anonymous_80.PDF_ENUM_NAME_OutputIntents;
    enum PDF_ENUM_NAME_P = _Anonymous_80.PDF_ENUM_NAME_P;
    enum PDF_ENUM_NAME_PDF = _Anonymous_80.PDF_ENUM_NAME_PDF;
    enum PDF_ENUM_NAME_PS = _Anonymous_80.PDF_ENUM_NAME_PS;
    enum PDF_ENUM_NAME_Page = _Anonymous_80.PDF_ENUM_NAME_Page;
    enum PDF_ENUM_NAME_PageMode = _Anonymous_80.PDF_ENUM_NAME_PageMode;
    enum PDF_ENUM_NAME_Pages = _Anonymous_80.PDF_ENUM_NAME_Pages;
    enum PDF_ENUM_NAME_PaintType = _Anonymous_80.PDF_ENUM_NAME_PaintType;
    enum PDF_ENUM_NAME_Params = _Anonymous_80.PDF_ENUM_NAME_Params;
    enum PDF_ENUM_NAME_Parent = _Anonymous_80.PDF_ENUM_NAME_Parent;
    enum PDF_ENUM_NAME_Pattern = _Anonymous_80.PDF_ENUM_NAME_Pattern;
    enum PDF_ENUM_NAME_PatternType = _Anonymous_80.PDF_ENUM_NAME_PatternType;
    enum PDF_ENUM_NAME_Perms = _Anonymous_80.PDF_ENUM_NAME_Perms;
    enum PDF_ENUM_NAME_PolyLine = _Anonymous_80.PDF_ENUM_NAME_PolyLine;
    enum PDF_ENUM_NAME_Polygon = _Anonymous_80.PDF_ENUM_NAME_Polygon;
    enum PDF_ENUM_NAME_Popup = _Anonymous_80.PDF_ENUM_NAME_Popup;
    enum PDF_ENUM_NAME_PreRelease = _Anonymous_80.PDF_ENUM_NAME_PreRelease;
    enum PDF_ENUM_NAME_Predictor = _Anonymous_80.PDF_ENUM_NAME_Predictor;
    enum PDF_ENUM_NAME_Prev = _Anonymous_80.PDF_ENUM_NAME_Prev;
    enum PDF_ENUM_NAME_PrevPage = _Anonymous_80.PDF_ENUM_NAME_PrevPage;
    enum PDF_ENUM_NAME_Preview = _Anonymous_80.PDF_ENUM_NAME_Preview;
    enum PDF_ENUM_NAME_Print = _Anonymous_80.PDF_ENUM_NAME_Print;
    enum PDF_ENUM_NAME_PrinterMark = _Anonymous_80.PDF_ENUM_NAME_PrinterMark;
    enum PDF_ENUM_NAME_ProcSet = _Anonymous_80.PDF_ENUM_NAME_ProcSet;
    enum PDF_ENUM_NAME_Producer = _Anonymous_80.PDF_ENUM_NAME_Producer;
    enum PDF_ENUM_NAME_Properties = _Anonymous_80.PDF_ENUM_NAME_Properties;
    enum PDF_ENUM_NAME_Prop_AuthTime = _Anonymous_80.PDF_ENUM_NAME_Prop_AuthTime;
    enum PDF_ENUM_NAME_Prop_AuthType = _Anonymous_80.PDF_ENUM_NAME_Prop_AuthType;
    enum PDF_ENUM_NAME_Prop_Build = _Anonymous_80.PDF_ENUM_NAME_Prop_Build;
    enum PDF_ENUM_NAME_PubSec = _Anonymous_80.PDF_ENUM_NAME_PubSec;
    enum PDF_ENUM_NAME_Push = _Anonymous_80.PDF_ENUM_NAME_Push;
    enum PDF_ENUM_NAME_Q = _Anonymous_80.PDF_ENUM_NAME_Q;
    enum PDF_ENUM_NAME_QuadPoints = _Anonymous_80.PDF_ENUM_NAME_QuadPoints;
    enum PDF_ENUM_NAME_R = _Anonymous_80.PDF_ENUM_NAME_R;
    enum PDF_ENUM_NAME_RBGroups = _Anonymous_80.PDF_ENUM_NAME_RBGroups;
    enum PDF_ENUM_NAME_RC = _Anonymous_80.PDF_ENUM_NAME_RC;
    enum PDF_ENUM_NAME_RClosedArrow = _Anonymous_80.PDF_ENUM_NAME_RClosedArrow;
    enum PDF_ENUM_NAME_REx = _Anonymous_80.PDF_ENUM_NAME_REx;
    enum PDF_ENUM_NAME_RGB = _Anonymous_80.PDF_ENUM_NAME_RGB;
    enum PDF_ENUM_NAME_RI = _Anonymous_80.PDF_ENUM_NAME_RI;
    enum PDF_ENUM_NAME_RL = _Anonymous_80.PDF_ENUM_NAME_RL;
    enum PDF_ENUM_NAME_ROpenArrow = _Anonymous_80.PDF_ENUM_NAME_ROpenArrow;
    enum PDF_ENUM_NAME_Range = _Anonymous_80.PDF_ENUM_NAME_Range;
    enum PDF_ENUM_NAME_Reason = _Anonymous_80.PDF_ENUM_NAME_Reason;
    enum PDF_ENUM_NAME_Rect = _Anonymous_80.PDF_ENUM_NAME_Rect;
    enum PDF_ENUM_NAME_Redact = _Anonymous_80.PDF_ENUM_NAME_Redact;
    enum PDF_ENUM_NAME_Ref = _Anonymous_80.PDF_ENUM_NAME_Ref;
    enum PDF_ENUM_NAME_Reference = _Anonymous_80.PDF_ENUM_NAME_Reference;
    enum PDF_ENUM_NAME_Registry = _Anonymous_80.PDF_ENUM_NAME_Registry;
    enum PDF_ENUM_NAME_ResetForm = _Anonymous_80.PDF_ENUM_NAME_ResetForm;
    enum PDF_ENUM_NAME_Resources = _Anonymous_80.PDF_ENUM_NAME_Resources;
    enum PDF_ENUM_NAME_Root = _Anonymous_80.PDF_ENUM_NAME_Root;
    enum PDF_ENUM_NAME_Rotate = _Anonymous_80.PDF_ENUM_NAME_Rotate;
    enum PDF_ENUM_NAME_Rows = _Anonymous_80.PDF_ENUM_NAME_Rows;
    enum PDF_ENUM_NAME_RunLengthDecode = _Anonymous_80.PDF_ENUM_NAME_RunLengthDecode;
    enum PDF_ENUM_NAME_S = _Anonymous_80.PDF_ENUM_NAME_S;
    enum PDF_ENUM_NAME_SMask = _Anonymous_80.PDF_ENUM_NAME_SMask;
    enum PDF_ENUM_NAME_SMaskInData = _Anonymous_80.PDF_ENUM_NAME_SMaskInData;
    enum PDF_ENUM_NAME_Schema = _Anonymous_80.PDF_ENUM_NAME_Schema;
    enum PDF_ENUM_NAME_Screen = _Anonymous_80.PDF_ENUM_NAME_Screen;
    enum PDF_ENUM_NAME_Separation = _Anonymous_80.PDF_ENUM_NAME_Separation;
    enum PDF_ENUM_NAME_Shading = _Anonymous_80.PDF_ENUM_NAME_Shading;
    enum PDF_ENUM_NAME_ShadingType = _Anonymous_80.PDF_ENUM_NAME_ShadingType;
    enum PDF_ENUM_NAME_Si = _Anonymous_80.PDF_ENUM_NAME_Si;
    enum PDF_ENUM_NAME_Sig = _Anonymous_80.PDF_ENUM_NAME_Sig;
    enum PDF_ENUM_NAME_SigFlags = _Anonymous_80.PDF_ENUM_NAME_SigFlags;
    enum PDF_ENUM_NAME_SigQ = _Anonymous_80.PDF_ENUM_NAME_SigQ;
    enum PDF_ENUM_NAME_SigRef = _Anonymous_80.PDF_ENUM_NAME_SigRef;
    enum PDF_ENUM_NAME_Size = _Anonymous_80.PDF_ENUM_NAME_Size;
    enum PDF_ENUM_NAME_Slash = _Anonymous_80.PDF_ENUM_NAME_Slash;
    enum PDF_ENUM_NAME_Sold = _Anonymous_80.PDF_ENUM_NAME_Sold;
    enum PDF_ENUM_NAME_Sound = _Anonymous_80.PDF_ENUM_NAME_Sound;
    enum PDF_ENUM_NAME_Split = _Anonymous_80.PDF_ENUM_NAME_Split;
    enum PDF_ENUM_NAME_Square = _Anonymous_80.PDF_ENUM_NAME_Square;
    enum PDF_ENUM_NAME_Squiggly = _Anonymous_80.PDF_ENUM_NAME_Squiggly;
    enum PDF_ENUM_NAME_Stamp = _Anonymous_80.PDF_ENUM_NAME_Stamp;
    enum PDF_ENUM_NAME_Standard = _Anonymous_80.PDF_ENUM_NAME_Standard;
    enum PDF_ENUM_NAME_StdCF = _Anonymous_80.PDF_ENUM_NAME_StdCF;
    enum PDF_ENUM_NAME_StemV = _Anonymous_80.PDF_ENUM_NAME_StemV;
    enum PDF_ENUM_NAME_StmF = _Anonymous_80.PDF_ENUM_NAME_StmF;
    enum PDF_ENUM_NAME_StrF = _Anonymous_80.PDF_ENUM_NAME_StrF;
    enum PDF_ENUM_NAME_StrikeOut = _Anonymous_80.PDF_ENUM_NAME_StrikeOut;
    enum PDF_ENUM_NAME_StructParent = _Anonymous_80.PDF_ENUM_NAME_StructParent;
    enum PDF_ENUM_NAME_StructParents = _Anonymous_80.PDF_ENUM_NAME_StructParents;
    enum PDF_ENUM_NAME_SubFilter = _Anonymous_80.PDF_ENUM_NAME_SubFilter;
    enum PDF_ENUM_NAME_Subtype = _Anonymous_80.PDF_ENUM_NAME_Subtype;
    enum PDF_ENUM_NAME_Subtype2 = _Anonymous_80.PDF_ENUM_NAME_Subtype2;
    enum PDF_ENUM_NAME_Supplement = _Anonymous_80.PDF_ENUM_NAME_Supplement;
    enum PDF_ENUM_NAME_Symb = _Anonymous_80.PDF_ENUM_NAME_Symb;
    enum PDF_ENUM_NAME_T = _Anonymous_80.PDF_ENUM_NAME_T;
    enum PDF_ENUM_NAME_TI = _Anonymous_80.PDF_ENUM_NAME_TI;
    enum PDF_ENUM_NAME_TR = _Anonymous_80.PDF_ENUM_NAME_TR;
    enum PDF_ENUM_NAME_TR2 = _Anonymous_80.PDF_ENUM_NAME_TR2;
    enum PDF_ENUM_NAME_TU = _Anonymous_80.PDF_ENUM_NAME_TU;
    enum PDF_ENUM_NAME_Text = _Anonymous_80.PDF_ENUM_NAME_Text;
    enum PDF_ENUM_NAME_TilingType = _Anonymous_80.PDF_ENUM_NAME_TilingType;
    enum PDF_ENUM_NAME_Times = _Anonymous_80.PDF_ENUM_NAME_Times;
    enum PDF_ENUM_NAME_Title = _Anonymous_80.PDF_ENUM_NAME_Title;
    enum PDF_ENUM_NAME_ToUnicode = _Anonymous_80.PDF_ENUM_NAME_ToUnicode;
    enum PDF_ENUM_NAME_TopSecret = _Anonymous_80.PDF_ENUM_NAME_TopSecret;
    enum PDF_ENUM_NAME_Trans = _Anonymous_80.PDF_ENUM_NAME_Trans;
    enum PDF_ENUM_NAME_TransformMethod = _Anonymous_80.PDF_ENUM_NAME_TransformMethod;
    enum PDF_ENUM_NAME_TransformParams = _Anonymous_80.PDF_ENUM_NAME_TransformParams;
    enum PDF_ENUM_NAME_Transparency = _Anonymous_80.PDF_ENUM_NAME_Transparency;
    enum PDF_ENUM_NAME_TrapNet = _Anonymous_80.PDF_ENUM_NAME_TrapNet;
    enum PDF_ENUM_NAME_TrimBox = _Anonymous_80.PDF_ENUM_NAME_TrimBox;
    enum PDF_ENUM_NAME_TrueType = _Anonymous_80.PDF_ENUM_NAME_TrueType;
    enum PDF_ENUM_NAME_TrustedMode = _Anonymous_80.PDF_ENUM_NAME_TrustedMode;
    enum PDF_ENUM_NAME_Tx = _Anonymous_80.PDF_ENUM_NAME_Tx;
    enum PDF_ENUM_NAME_Type = _Anonymous_80.PDF_ENUM_NAME_Type;
    enum PDF_ENUM_NAME_Type0 = _Anonymous_80.PDF_ENUM_NAME_Type0;
    enum PDF_ENUM_NAME_Type1 = _Anonymous_80.PDF_ENUM_NAME_Type1;
    enum PDF_ENUM_NAME_Type1C = _Anonymous_80.PDF_ENUM_NAME_Type1C;
    enum PDF_ENUM_NAME_Type3 = _Anonymous_80.PDF_ENUM_NAME_Type3;
    enum PDF_ENUM_NAME_U = _Anonymous_80.PDF_ENUM_NAME_U;
    enum PDF_ENUM_NAME_UE = _Anonymous_80.PDF_ENUM_NAME_UE;
    enum PDF_ENUM_NAME_UF = _Anonymous_80.PDF_ENUM_NAME_UF;
    enum PDF_ENUM_NAME_URI = _Anonymous_80.PDF_ENUM_NAME_URI;
    enum PDF_ENUM_NAME_URL = _Anonymous_80.PDF_ENUM_NAME_URL;
    enum PDF_ENUM_NAME_Unchanged = _Anonymous_80.PDF_ENUM_NAME_Unchanged;
    enum PDF_ENUM_NAME_Uncover = _Anonymous_80.PDF_ENUM_NAME_Uncover;
    enum PDF_ENUM_NAME_Underline = _Anonymous_80.PDF_ENUM_NAME_Underline;
    enum PDF_ENUM_NAME_Unix = _Anonymous_80.PDF_ENUM_NAME_Unix;
    enum PDF_ENUM_NAME_Usage = _Anonymous_80.PDF_ENUM_NAME_Usage;
    enum PDF_ENUM_NAME_UseBlackPtComp = _Anonymous_80.PDF_ENUM_NAME_UseBlackPtComp;
    enum PDF_ENUM_NAME_UseCMap = _Anonymous_80.PDF_ENUM_NAME_UseCMap;
    enum PDF_ENUM_NAME_UseOutlines = _Anonymous_80.PDF_ENUM_NAME_UseOutlines;
    enum PDF_ENUM_NAME_UserUnit = _Anonymous_80.PDF_ENUM_NAME_UserUnit;
    enum PDF_ENUM_NAME_V = _Anonymous_80.PDF_ENUM_NAME_V;
    enum PDF_ENUM_NAME_V2 = _Anonymous_80.PDF_ENUM_NAME_V2;
    enum PDF_ENUM_NAME_VE = _Anonymous_80.PDF_ENUM_NAME_VE;
    enum PDF_ENUM_NAME_Version = _Anonymous_80.PDF_ENUM_NAME_Version;
    enum PDF_ENUM_NAME_Vertices = _Anonymous_80.PDF_ENUM_NAME_Vertices;
    enum PDF_ENUM_NAME_VerticesPerRow = _Anonymous_80.PDF_ENUM_NAME_VerticesPerRow;
    enum PDF_ENUM_NAME_View = _Anonymous_80.PDF_ENUM_NAME_View;
    enum PDF_ENUM_NAME_W = _Anonymous_80.PDF_ENUM_NAME_W;
    enum PDF_ENUM_NAME_W2 = _Anonymous_80.PDF_ENUM_NAME_W2;
    enum PDF_ENUM_NAME_WMode = _Anonymous_80.PDF_ENUM_NAME_WMode;
    enum PDF_ENUM_NAME_Watermark = _Anonymous_80.PDF_ENUM_NAME_Watermark;
    enum PDF_ENUM_NAME_WhitePoint = _Anonymous_80.PDF_ENUM_NAME_WhitePoint;
    enum PDF_ENUM_NAME_Widget = _Anonymous_80.PDF_ENUM_NAME_Widget;
    enum PDF_ENUM_NAME_Width = _Anonymous_80.PDF_ENUM_NAME_Width;
    enum PDF_ENUM_NAME_Widths = _Anonymous_80.PDF_ENUM_NAME_Widths;
    enum PDF_ENUM_NAME_WinAnsiEncoding = _Anonymous_80.PDF_ENUM_NAME_WinAnsiEncoding;
    enum PDF_ENUM_NAME_Wipe = _Anonymous_80.PDF_ENUM_NAME_Wipe;
    enum PDF_ENUM_NAME_XFA = _Anonymous_80.PDF_ENUM_NAME_XFA;
    enum PDF_ENUM_NAME_XHeight = _Anonymous_80.PDF_ENUM_NAME_XHeight;
    enum PDF_ENUM_NAME_XML = _Anonymous_80.PDF_ENUM_NAME_XML;
    enum PDF_ENUM_NAME_XObject = _Anonymous_80.PDF_ENUM_NAME_XObject;
    enum PDF_ENUM_NAME_XRef = _Anonymous_80.PDF_ENUM_NAME_XRef;
    enum PDF_ENUM_NAME_XRefStm = _Anonymous_80.PDF_ENUM_NAME_XRefStm;
    enum PDF_ENUM_NAME_XStep = _Anonymous_80.PDF_ENUM_NAME_XStep;
    enum PDF_ENUM_NAME_XYZ = _Anonymous_80.PDF_ENUM_NAME_XYZ;
    enum PDF_ENUM_NAME_YStep = _Anonymous_80.PDF_ENUM_NAME_YStep;
    enum PDF_ENUM_NAME_Yes = _Anonymous_80.PDF_ENUM_NAME_Yes;
    enum PDF_ENUM_NAME_ZaDb = _Anonymous_80.PDF_ENUM_NAME_ZaDb;
    enum PDF_ENUM_NAME_adbe_pkcs7_detached = _Anonymous_80.PDF_ENUM_NAME_adbe_pkcs7_detached;
    enum PDF_ENUM_NAME_ca = _Anonymous_80.PDF_ENUM_NAME_ca;
    enum PDF_ENUM_NAME_n0 = _Anonymous_80.PDF_ENUM_NAME_n0;
    enum PDF_ENUM_NAME_n1 = _Anonymous_80.PDF_ENUM_NAME_n1;
    enum PDF_ENUM_NAME_n2 = _Anonymous_80.PDF_ENUM_NAME_n2;
    enum PDF_ENUM_NAME_op = _Anonymous_80.PDF_ENUM_NAME_op;
    enum PDF_ENUM_LIMIT = _Anonymous_80.PDF_ENUM_LIMIT;
    ...
    enum PDF_REDACT_IMAGE_NONE = _Anonymous_81.PDF_REDACT_IMAGE_NONE;
    enum PDF_REDACT_IMAGE_REMOVE = _Anonymous_81.PDF_REDACT_IMAGE_REMOVE;
    enum PDF_REDACT_IMAGE_PIXELS = _Anonymous_81.PDF_REDACT_IMAGE_PIXELS;
    ...
    enum PDF_TOK_ERROR = _Anonymous_82.PDF_TOK_ERROR;
    enum PDF_TOK_EOF = _Anonymous_82.PDF_TOK_EOF;
    enum PDF_TOK_OPEN_ARRAY = _Anonymous_82.PDF_TOK_OPEN_ARRAY;
    enum PDF_TOK_CLOSE_ARRAY = _Anonymous_82.PDF_TOK_CLOSE_ARRAY;
    enum PDF_TOK_OPEN_DICT = _Anonymous_82.PDF_TOK_OPEN_DICT;
    enum PDF_TOK_CLOSE_DICT = _Anonymous_82.PDF_TOK_CLOSE_DICT;
    enum PDF_TOK_OPEN_BRACE = _Anonymous_82.PDF_TOK_OPEN_BRACE;
    enum PDF_TOK_CLOSE_BRACE = _Anonymous_82.PDF_TOK_CLOSE_BRACE;
    enum PDF_TOK_NAME = _Anonymous_82.PDF_TOK_NAME;
    enum PDF_TOK_INT = _Anonymous_82.PDF_TOK_INT;
    enum PDF_TOK_REAL = _Anonymous_82.PDF_TOK_REAL;
    enum PDF_TOK_STRING = _Anonymous_82.PDF_TOK_STRING;
    enum PDF_TOK_KEYWORD = _Anonymous_82.PDF_TOK_KEYWORD;
    enum PDF_TOK_R = _Anonymous_82.PDF_TOK_R;
    enum PDF_TOK_TRUE = _Anonymous_82.PDF_TOK_TRUE;
    enum PDF_TOK_FALSE = _Anonymous_82.PDF_TOK_FALSE;
    enum PDF_TOK_NULL = _Anonymous_82.PDF_TOK_NULL;
    enum PDF_TOK_OBJ = _Anonymous_82.PDF_TOK_OBJ;
    enum PDF_TOK_ENDOBJ = _Anonymous_82.PDF_TOK_ENDOBJ;
    enum PDF_TOK_STREAM = _Anonymous_82.PDF_TOK_STREAM;
    enum PDF_TOK_ENDSTREAM = _Anonymous_82.PDF_TOK_ENDSTREAM;
    enum PDF_TOK_XREF = _Anonymous_82.PDF_TOK_XREF;
    enum PDF_TOK_TRAILER = _Anonymous_82.PDF_TOK_TRAILER;
    enum PDF_TOK_STARTXREF = _Anonymous_82.PDF_TOK_STARTXREF;
    enum PDF_TOK_NEWOBJ = _Anonymous_82.PDF_TOK_NEWOBJ;
    enum PDF_NUM_TOKENS = _Anonymous_82.PDF_NUM_TOKENS;
    ...
    enum PDF_SIMPLE_FONT_RESOURCE = _Anonymous_83.PDF_SIMPLE_FONT_RESOURCE;
    enum PDF_CID_FONT_RESOURCE = _Anonymous_83.PDF_CID_FONT_RESOURCE;
    enum PDF_CJK_FONT_RESOURCE = _Anonymous_83.PDF_CJK_FONT_RESOURCE;
    ...
    enum PDF_SIMPLE_ENCODING_LATIN = _Anonymous_84.PDF_SIMPLE_ENCODING_LATIN;
    enum PDF_SIMPLE_ENCODING_GREEK = _Anonymous_84.PDF_SIMPLE_ENCODING_GREEK;
    enum PDF_SIMPLE_ENCODING_CYRILLIC = _Anonymous_84.PDF_SIMPLE_ENCODING_CYRILLIC;
    ...
    fz_compressed_buffer* pdf_load_compressed_stream(fz_context*, pdf_document*, int) @nogc nothrow;
    ...
    static if(!is(typeof(FZ_VERSION_MINOR))) {
        private enum enumMixinStr_FZ_VERSION_MINOR = `enum FZ_VERSION_MINOR = 19;`;
    ...
    static if(!is(typeof(FZ_VERSION))) {
        private enum enumMixinStr_FZ_VERSION = `enum FZ_VERSION = "1.19.0";`;
...
auto fz_new_context(const(fz_alloc_context)* alloc, const(fz_locks_context)* locks, c_ulong max_store) {
    return fz_new_context_imp(alloc, locks, max_store, "1.19.0");
}


template PDF_NAME(string T) {
    const char[] PDF_NAME = "auto PDF_NAME_" ~ T ~ " = cast(pdf_obj*) PDF_ENUM_NAME_" ~ T ~ ";";
}
...
mixin(PDF_NAME!("AA"));
mixin(PDF_NAME!("AC"));
mixin(PDF_NAME!("AESV2"));
mixin(PDF_NAME!("AESV3"));
mixin(PDF_NAME!("AHx"));
mixin(PDF_NAME!("AP"));
mixin(PDF_NAME!("AS"));
mixin(PDF_NAME!("ASCII85Decode"));
mixin(PDF_NAME!("ASCIIHexDecode"));
mixin(PDF_NAME!("AcroForm"));
mixin(PDF_NAME!("Action"));
mixin(PDF_NAME!("ActualText"));
mixin(PDF_NAME!("Adobe_PPKLite"));
mixin(PDF_NAME!("All"));
mixin(PDF_NAME!("AllOff"));
mixin(PDF_NAME!("AllOn"));
mixin(PDF_NAME!("Alpha"));
mixin(PDF_NAME!("Alt"));
mixin(PDF_NAME!("Alternate"));
mixin(PDF_NAME!("Annot"));
mixin(PDF_NAME!("Annots"));
mixin(PDF_NAME!("AnyOff"));
mixin(PDF_NAME!("App"));
mixin(PDF_NAME!("Approved"));
mixin(PDF_NAME!("ArtBox"));
mixin(PDF_NAME!("AsIs"));
mixin(PDF_NAME!("Ascent"));
mixin(PDF_NAME!("AuthEvent"));
mixin(PDF_NAME!("B"));
mixin(PDF_NAME!("BBox"));
mixin(PDF_NAME!("BC"));
mixin(PDF_NAME!("BE"));
...
mixin(PDF_NAME!("BPC"));
mixin(PDF_NAME!("BS"));
mixin(PDF_NAME!("Background"));
mixin(PDF_NAME!("BaseEncoding"));
mixin(PDF_NAME!("BaseFont"));
mixin(PDF_NAME!("BaseState"));
mixin(PDF_NAME!("BitsPerComponent"));
mixin(PDF_NAME!("BitsPerCoordinate"));
mixin(PDF_NAME!("BitsPerFlag"));
mixin(PDF_NAME!("BitsPerSample"));
mixin(PDF_NAME!("BlackIs1"));
mixin(PDF_NAME!("BlackPoint"));
mixin(PDF_NAME!("BleedBox"));
mixin(PDF_NAME!("Blinds"));
mixin(PDF_NAME!("Border"));
mixin(PDF_NAME!("Bounds"));
mixin(PDF_NAME!("Box"));
mixin(PDF_NAME!("Bt"));
mixin(PDF_NAME!("Btn"));
mixin(PDF_NAME!("Butt"));
mixin(PDF_NAME!("ByteRange"));
mixin(PDF_NAME!("C"));
mixin(PDF_NAME!("C0"));
mixin(PDF_NAME!("C1"));
mixin(PDF_NAME!("CA"));
mixin(PDF_NAME!("CCF"));
mixin(PDF_NAME!("CCITTFaxDecode"));
mixin(PDF_NAME!("CF"));
mixin(PDF_NAME!("CFM"));
mixin(PDF_NAME!("CI"));
mixin(PDF_NAME!("CIDFontType0"));
mixin(PDF_NAME!("CIDFontType0C"));
mixin(PDF_NAME!("CIDFontType2"));
mixin(PDF_NAME!("CIDSystemInfo"));
mixin(PDF_NAME!("CIDToGIDMap"));
mixin(PDF_NAME!("CMYK"));
mixin(PDF_NAME!("CS"));
mixin(PDF_NAME!("CalCMYK"));
mixin(PDF_NAME!("CalGray"));
mixin(PDF_NAME!("CalRGB"));
mixin(PDF_NAME!("CapHeight"));
mixin(PDF_NAME!("Caret"));
mixin(PDF_NAME!("Catalog"));
mixin(PDF_NAME!("Cert"));
mixin(PDF_NAME!("Ch"));
mixin(PDF_NAME!("Changes"));
mixin(PDF_NAME!("CharProcs"));
mixin(PDF_NAME!("Circle"));
mixin(PDF_NAME!("ClosedArrow"));
mixin(PDF_NAME!("Collection"));
mixin(PDF_NAME!("ColorSpace"));
mixin(PDF_NAME!("ColorTransform"));
mixin(PDF_NAME!("Colorants"));
mixin(PDF_NAME!("Colors"));
mixin(PDF_NAME!("Columns"));
mixin(PDF_NAME!("Confidential"));
mixin(PDF_NAME!("Configs"));
mixin(PDF_NAME!("ContactInfo"));
mixin(PDF_NAME!("Contents"));
mixin(PDF_NAME!("Coords"));
mixin(PDF_NAME!("Count"));
mixin(PDF_NAME!("Cover"));
mixin(PDF_NAME!("CreationDate"));
mixin(PDF_NAME!("Creator"));
mixin(PDF_NAME!("CropBox"));
mixin(PDF_NAME!("Crypt"));
mixin(PDF_NAME!("D"));
mixin(PDF_NAME!("DA"));
mixin(PDF_NAME!("DC"));
mixin(PDF_NAME!("DCT"));
mixin(PDF_NAME!("DCTDecode"));
mixin(PDF_NAME!("DL"));
mixin(PDF_NAME!("DOS"));
mixin(PDF_NAME!("DP"));
mixin(PDF_NAME!("DR"));
...
mixin(PDF_NAME!("DW"));
mixin(PDF_NAME!("DW2"));
mixin(PDF_NAME!("DamagedRowsBeforeError"));
mixin(PDF_NAME!("Data"));
mixin(PDF_NAME!("Date"));
mixin(PDF_NAME!("Decode"));
mixin(PDF_NAME!("DecodeParms"));
mixin(PDF_NAME!("Default"));
mixin(PDF_NAME!("DefaultCMYK"));
mixin(PDF_NAME!("DefaultGray"));
mixin(PDF_NAME!("DefaultRGB"));
mixin(PDF_NAME!("Departmental"));
mixin(PDF_NAME!("Desc"));
mixin(PDF_NAME!("DescendantFonts"));
mixin(PDF_NAME!("Descent"));
mixin(PDF_NAME!("Design"));
mixin(PDF_NAME!("Dest"));
mixin(PDF_NAME!("DestOutputProfile"));
mixin(PDF_NAME!("Dests"));
mixin(PDF_NAME!("DeviceCMYK"));
mixin(PDF_NAME!("DeviceGray"));
mixin(PDF_NAME!("DeviceN"));
mixin(PDF_NAME!("DeviceRGB"));
mixin(PDF_NAME!("Di"));
mixin(PDF_NAME!("Diamond"));
mixin(PDF_NAME!("Differences"));
mixin(PDF_NAME!("DigestLocation"));
mixin(PDF_NAME!("DigestMethod"));
mixin(PDF_NAME!("DigestValue"));
mixin(PDF_NAME!("Dissolve"));
mixin(PDF_NAME!("Dm"));
mixin(PDF_NAME!("DocMDP"));
mixin(PDF_NAME!("Document"));
mixin(PDF_NAME!("Domain"));
mixin(PDF_NAME!("Draft"));
mixin(PDF_NAME!("Dur"));
mixin(PDF_NAME!("E"));
mixin(PDF_NAME!("EF"));
mixin(PDF_NAME!("EarlyChange"));
mixin(PDF_NAME!("EmbeddedFile"));
mixin(PDF_NAME!("EmbeddedFiles"));
mixin(PDF_NAME!("Encode"));
mixin(PDF_NAME!("EncodedByteAlign"));
mixin(PDF_NAME!("Encoding"));
mixin(PDF_NAME!("Encrypt"));
mixin(PDF_NAME!("EncryptMetadata"));
mixin(PDF_NAME!("EndOfBlock"));
mixin(PDF_NAME!("EndOfLine"));
mixin(PDF_NAME!("Exclude"));
mixin(PDF_NAME!("Experimental"));
mixin(PDF_NAME!("Expired"));
mixin(PDF_NAME!("ExtGState"));
mixin(PDF_NAME!("Extend"));
mixin(PDF_NAME!("F"));
mixin(PDF_NAME!("FL"));
mixin(PDF_NAME!("FRM"));
mixin(PDF_NAME!("FS"));
...
mixin(PDF_NAME!("Fade"));
mixin(PDF_NAME!("Ff"));
mixin(PDF_NAME!("FieldMDP"));
mixin(PDF_NAME!("Fields"));
mixin(PDF_NAME!("FileAttachment"));
mixin(PDF_NAME!("FileSize"));
mixin(PDF_NAME!("Filespec"));
mixin(PDF_NAME!("Filter"));
mixin(PDF_NAME!("Final"));
mixin(PDF_NAME!("Fingerprint"));
mixin(PDF_NAME!("First"));
mixin(PDF_NAME!("FirstChar"));
mixin(PDF_NAME!("FirstPage"));
mixin(PDF_NAME!("Fit"));
mixin(PDF_NAME!("FitB"));
mixin(PDF_NAME!("FitBH"));
mixin(PDF_NAME!("FitBV"));
mixin(PDF_NAME!("FitH"));
mixin(PDF_NAME!("FitR"));
mixin(PDF_NAME!("FitV"));
mixin(PDF_NAME!("Fl"));
mixin(PDF_NAME!("Flags"));
mixin(PDF_NAME!("FlateDecode"));
mixin(PDF_NAME!("Fly"));
mixin(PDF_NAME!("Font"));
mixin(PDF_NAME!("FontBBox"));
mixin(PDF_NAME!("FontDescriptor"));
mixin(PDF_NAME!("FontFile"));
mixin(PDF_NAME!("FontFile2"));
mixin(PDF_NAME!("FontFile3"));
mixin(PDF_NAME!("FontMatrix"));
mixin(PDF_NAME!("FontName"));
mixin(PDF_NAME!("ForComment"));
mixin(PDF_NAME!("ForPublicRelease"));
mixin(PDF_NAME!("Form"));
mixin(PDF_NAME!("FormEx"));
mixin(PDF_NAME!("FormType"));
mixin(PDF_NAME!("FreeText"));
mixin(PDF_NAME!("Function"));
mixin(PDF_NAME!("FunctionType"));
mixin(PDF_NAME!("Functions"));
mixin(PDF_NAME!("G"));
mixin(PDF_NAME!("Gamma"));
mixin(PDF_NAME!("Glitter"));
mixin(PDF_NAME!("GoTo"));
mixin(PDF_NAME!("GoToR"));
mixin(PDF_NAME!("Group"));
mixin(PDF_NAME!("H"));
mixin(PDF_NAME!("Height"));
mixin(PDF_NAME!("Helv"));
mixin(PDF_NAME!("Highlight"));
mixin(PDF_NAME!("HistoryPos"));
mixin(PDF_NAME!("I"));
mixin(PDF_NAME!("IC"));
mixin(PDF_NAME!("ICCBased"));
mixin(PDF_NAME!("ID"));
mixin(PDF_NAME!("IM"));
mixin(PDF_NAME!("IRT"));
mixin(PDF_NAME!("Identity"));
mixin(PDF_NAME!("Identity_H"));
mixin(PDF_NAME!("Identity_V"));
mixin(PDF_NAME!("Image"));
mixin(PDF_NAME!("ImageMask"));
mixin(PDF_NAME!("Include"));
mixin(PDF_NAME!("Index"));
mixin(PDF_NAME!("Indexed"));
mixin(PDF_NAME!("Info"));
mixin(PDF_NAME!("Ink"));
mixin(PDF_NAME!("InkList"));
mixin(PDF_NAME!("Intent"));
mixin(PDF_NAME!("Interpolate"));
mixin(PDF_NAME!("IsMap"));
mixin(PDF_NAME!("ItalicAngle"));
mixin(PDF_NAME!("JBIG2Decode"));
mixin(PDF_NAME!("JBIG2Globals"));
mixin(PDF_NAME!("JPXDecode"));
mixin(PDF_NAME!("JS"));
mixin(PDF_NAME!("JavaScript"));
mixin(PDF_NAME!("K"));
mixin(PDF_NAME!("Kids"));
mixin(PDF_NAME!("L"));
mixin(PDF_NAME!("LC"));
...
mixin(PDF_NAME!("LZ"));
mixin(PDF_NAME!("LZW"));
mixin(PDF_NAME!("LZWDecode"));
mixin(PDF_NAME!("Lab"));
mixin(PDF_NAME!("Lang"));
mixin(PDF_NAME!("Last"));
mixin(PDF_NAME!("LastChar"));
mixin(PDF_NAME!("LastPage"));
mixin(PDF_NAME!("Launch"));
mixin(PDF_NAME!("Length"));
mixin(PDF_NAME!("Length1"));
mixin(PDF_NAME!("Length2"));
mixin(PDF_NAME!("Length3"));
mixin(PDF_NAME!("Limits"));
mixin(PDF_NAME!("Line"));
mixin(PDF_NAME!("Linearized"));
mixin(PDF_NAME!("Link"));
mixin(PDF_NAME!("Location"));
mixin(PDF_NAME!("Lock"));
mixin(PDF_NAME!("Locked"));
mixin(PDF_NAME!("Luminosity"));
mixin(PDF_NAME!("M"));
mixin(PDF_NAME!("MCID"));
mixin(PDF_NAME!("MK"));
mixin(PDF_NAME!("ML"));
mixin(PDF_NAME!("MMType1"));
mixin(PDF_NAME!("Mac"));
mixin(PDF_NAME!("Mask"));
mixin(PDF_NAME!("Matrix"));
mixin(PDF_NAME!("Matte"));
mixin(PDF_NAME!("MaxLen"));
mixin(PDF_NAME!("MediaBox"));
mixin(PDF_NAME!("Metadata"));
mixin(PDF_NAME!("MissingWidth"));
mixin(PDF_NAME!("ModDate"));
mixin(PDF_NAME!("Movie"));
mixin(PDF_NAME!("Msg"));
mixin(PDF_NAME!("Multiply"));
mixin(PDF_NAME!("N"));
mixin(PDF_NAME!("Name"));
mixin(PDF_NAME!("Named"));
mixin(PDF_NAME!("Names"));
mixin(PDF_NAME!("NewWindow"));
mixin(PDF_NAME!("Next"));
mixin(PDF_NAME!("NextPage"));
mixin(PDF_NAME!("NonEFontNoWarn"));
mixin(PDF_NAME!("None"));
mixin(PDF_NAME!("Normal"));
mixin(PDF_NAME!("NotApproved"));
mixin(PDF_NAME!("NotForPublicRelease"));
mixin(PDF_NAME!("NumSections"));
mixin(PDF_NAME!("Nums"));
mixin(PDF_NAME!("O"));
mixin(PDF_NAME!("OC"));
mixin(PDF_NAME!("OCG"));
...
mixin(PDF_NAME!("OPM"));
mixin(PDF_NAME!("OS"));
mixin(PDF_NAME!("ObjStm"));
mixin(PDF_NAME!("Of"));
mixin(PDF_NAME!("Off"));
mixin(PDF_NAME!("Open"));
mixin(PDF_NAME!("OpenArrow"));
mixin(PDF_NAME!("OpenType"));
mixin(PDF_NAME!("Opt"));
mixin(PDF_NAME!("Order"));
mixin(PDF_NAME!("Ordering"));
mixin(PDF_NAME!("Outlines"));
mixin(PDF_NAME!("OutputIntents"));
mixin(PDF_NAME!("P"));
mixin(PDF_NAME!("PDF"));
mixin(PDF_NAME!("PS"));
mixin(PDF_NAME!("Page"));
mixin(PDF_NAME!("PageMode"));
mixin(PDF_NAME!("Pages"));
mixin(PDF_NAME!("PaintType"));
mixin(PDF_NAME!("Params"));
mixin(PDF_NAME!("Parent"));
mixin(PDF_NAME!("Pattern"));
mixin(PDF_NAME!("PatternType"));
mixin(PDF_NAME!("Perms"));
mixin(PDF_NAME!("PolyLine"));
mixin(PDF_NAME!("Polygon"));
mixin(PDF_NAME!("Popup"));
mixin(PDF_NAME!("PreRelease"));
mixin(PDF_NAME!("Predictor"));
mixin(PDF_NAME!("Prev"));
mixin(PDF_NAME!("PrevPage"));
mixin(PDF_NAME!("Preview"));
mixin(PDF_NAME!("Print"));
mixin(PDF_NAME!("PrinterMark"));
mixin(PDF_NAME!("ProcSet"));
mixin(PDF_NAME!("Producer"));
mixin(PDF_NAME!("Properties"));
mixin(PDF_NAME!("Prop_AuthTime"));
mixin(PDF_NAME!("Prop_AuthType"));
mixin(PDF_NAME!("Prop_Build"));
mixin(PDF_NAME!("PubSec"));
mixin(PDF_NAME!("Push"));
mixin(PDF_NAME!("Q"));
mixin(PDF_NAME!("QuadPoints"));
mixin(PDF_NAME!("R"));
mixin(PDF_NAME!("RBGroups"));
mixin(PDF_NAME!("RC"));
mixin(PDF_NAME!("RClosedArrow"));
mixin(PDF_NAME!("REx"));
mixin(PDF_NAME!("RGB"));
mixin(PDF_NAME!("RI"));
mixin(PDF_NAME!("RL"));
mixin(PDF_NAME!("ROpenArrow"));
mixin(PDF_NAME!("Range"));
mixin(PDF_NAME!("Reason"));
mixin(PDF_NAME!("Rect"));
mixin(PDF_NAME!("Redact"));
mixin(PDF_NAME!("Ref"));
mixin(PDF_NAME!("Reference"));
mixin(PDF_NAME!("Registry"));
mixin(PDF_NAME!("ResetForm"));
mixin(PDF_NAME!("Resources"));
mixin(PDF_NAME!("Root"));
mixin(PDF_NAME!("Rotate"));
mixin(PDF_NAME!("Rows"));
mixin(PDF_NAME!("RunLengthDecode"));
mixin(PDF_NAME!("S"));
mixin(PDF_NAME!("SMask"));
mixin(PDF_NAME!("SMaskInData"));
mixin(PDF_NAME!("Schema"));
mixin(PDF_NAME!("Screen"));
mixin(PDF_NAME!("Separation"));
mixin(PDF_NAME!("Shading"));
mixin(PDF_NAME!("ShadingType"));
mixin(PDF_NAME!("Si"));
mixin(PDF_NAME!("Sig"));
mixin(PDF_NAME!("SigFlags"));
mixin(PDF_NAME!("SigQ"));
mixin(PDF_NAME!("SigRef"));
mixin(PDF_NAME!("Size"));
mixin(PDF_NAME!("Slash"));
mixin(PDF_NAME!("Sold"));
mixin(PDF_NAME!("Sound"));
mixin(PDF_NAME!("Split"));
mixin(PDF_NAME!("Square"));
mixin(PDF_NAME!("Squiggly"));
mixin(PDF_NAME!("Stamp"));
mixin(PDF_NAME!("Standard"));
mixin(PDF_NAME!("StdCF"));
mixin(PDF_NAME!("StemV"));
mixin(PDF_NAME!("StmF"));
mixin(PDF_NAME!("StrF"));
mixin(PDF_NAME!("StrikeOut"));
mixin(PDF_NAME!("StructParent"));
mixin(PDF_NAME!("StructParents"));
mixin(PDF_NAME!("SubFilter"));
mixin(PDF_NAME!("Subtype"));
mixin(PDF_NAME!("Subtype2"));
mixin(PDF_NAME!("Supplement"));
mixin(PDF_NAME!("Symb"));
mixin(PDF_NAME!("T"));
mixin(PDF_NAME!("TI"));
mixin(PDF_NAME!("TR"));
...
mixin(PDF_NAME!("TU"));
mixin(PDF_NAME!("Text"));
mixin(PDF_NAME!("TilingType"));
mixin(PDF_NAME!("Times"));
mixin(PDF_NAME!("Title"));
mixin(PDF_NAME!("ToUnicode"));
mixin(PDF_NAME!("TopSecret"));
mixin(PDF_NAME!("Trans"));
mixin(PDF_NAME!("TransformMethod"));
mixin(PDF_NAME!("TransformParams"));
mixin(PDF_NAME!("Transparency"));
mixin(PDF_NAME!("TrapNet"));
mixin(PDF_NAME!("TrimBox"));
mixin(PDF_NAME!("TrueType"));
mixin(PDF_NAME!("TrustedMode"));
mixin(PDF_NAME!("Tx"));
mixin(PDF_NAME!("Type"));
mixin(PDF_NAME!("Type0"));
mixin(PDF_NAME!("Type1"));
mixin(PDF_NAME!("Type1C"));
mixin(PDF_NAME!("Type3"));
mixin(PDF_NAME!("U"));
mixin(PDF_NAME!("UE"));
mixin(PDF_NAME!("UF"));
mixin(PDF_NAME!("URI"));
mixin(PDF_NAME!("URL"));
mixin(PDF_NAME!("Unchanged"));
mixin(PDF_NAME!("Uncover"));
mixin(PDF_NAME!("Underline"));
mixin(PDF_NAME!("Unix"));
mixin(PDF_NAME!("Usage"));
mixin(PDF_NAME!("UseBlackPtComp"));
mixin(PDF_NAME!("UseCMap"));
mixin(PDF_NAME!("UseOutlines"));
mixin(PDF_NAME!("UserUnit"));
mixin(PDF_NAME!("V"));
mixin(PDF_NAME!("V2"));
mixin(PDF_NAME!("VE"));
mixin(PDF_NAME!("Version"));
mixin(PDF_NAME!("Vertices"));
mixin(PDF_NAME!("VerticesPerRow"));
mixin(PDF_NAME!("View"));
mixin(PDF_NAME!("W"));
mixin(PDF_NAME!("W2"));
mixin(PDF_NAME!("WMode"));
mixin(PDF_NAME!("Watermark"));
mixin(PDF_NAME!("WhitePoint"));
mixin(PDF_NAME!("Widget"));
mixin(PDF_NAME!("Width"));
mixin(PDF_NAME!("Widths"));
mixin(PDF_NAME!("WinAnsiEncoding"));
mixin(PDF_NAME!("Wipe"));
mixin(PDF_NAME!("XFA"));
mixin(PDF_NAME!("XHeight"));
mixin(PDF_NAME!("XML"));
mixin(PDF_NAME!("XObject"));
mixin(PDF_NAME!("XRef"));
mixin(PDF_NAME!("XRefStm"));
mixin(PDF_NAME!("XStep"));
mixin(PDF_NAME!("XYZ"));
mixin(PDF_NAME!("YStep"));
mixin(PDF_NAME!("Yes"));
mixin(PDF_NAME!("ZaDb"));
mixin(PDF_NAME!("adbe_pkcs7_detached"));
mixin(PDF_NAME!("ca"));
mixin(PDF_NAME!("n0"));
mixin(PDF_NAME!("n1"));
mixin(PDF_NAME!("n2"));
